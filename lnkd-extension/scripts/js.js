...
function BindEven() {
    ...
    $("body").on("click", "#j_inviteQueue_paging .j-paging", GetInviteQueueSomePage);
    $("body").on("click", "#j_inviteQueue_paging .j-jump-btn", JumpInviteQueue);
    $("body").on("keydown", "#j_inviteQueue_paging .j-jump", JumpInviteQueueEnter);
    ...
    $("body").on("click", "#j_connect_select_country .j-country-span", SelectConnectCountry);
    $("body").on("click", "#j_clean_connect_country", CleanSelectConnectCountry);
    $("body").on("click", "#j_determine_connect_country", DetermineSelectConnectCountry);
    $("body").on("input", "#j_connect_search_mutual", GetConnectMutual);
    $("body").on("click", "#j_connect_select_mutual .j-mutual-span", SelectConnectMutual);
    $("body").on("click", "#j_clean_connect_mutual", CleanSelectConnectMutual);
    $("body").on("click", "#j_determine_connect_mutual", DetermineSelectConnectMutual);
    $("body").on("input", "#j_connect_search_industry", GetConnectIndustry);
    $("body").on("click", "#j_connect_select_industry .j-industry-span", SelectConnectIndustry);
    $("body").on("click", "#j_clean_connect_industry", CleanSelectConnectIndustry);
    $("body").on("click", "#j_determine_connect_industry", DetermineSelectConnectIndustry);
    $("body").on("input", "#j_connect_search_company", GetConnectCompany);
    $("body").on("click", "#j_connect_select_company .j-company-span", SelectConnectCompany);
    $("body").on("click", "#j_clean_connect_company", CleanSelectConnectCompany);
    $("body").on("click", "#j_determine_connect_company", DetermineSelectConnectCompany);
    $("body").on("input", "#j_connect_search_school", GetConnectSchool);
    $("body").on("click", "#j_connect_select_school .j-school-span", SelectConnectSchool);
    $("body").on("click", "#j_clean_connect_school", CleanSelectConnectSchool);
    $("body").on("click", "#j_determine_connect_school", DetermineSelectConnectSchool);
    ...
    $("body").on("click", "#j_searchRecomm_paging .j-paging", GetSearchRecommSomePage);
    $("body").on("click", "#j_searchRecomm_paging .j-jump-btn", JumpSearchRecomm);
    $("body").on("keydown", "#j_searchRecomm_paging .j-jump", JumpSearchRecommEnter);
    ...
    $("body").on("click", "#j_friend_select_country .j-country-span", SelectFriendCountry);
    $("body").on("click", "#j_clean_friend_country", CleanSelectFriendCountry);
    $("body").on("click", "#j_determine_friend_country", DetermineSelectFriendCountry);
    $("body").on("input", "#j_friend_search_company", GetFriendCompany);
    $("body").on("click", "#j_friend_select_company .j-company-span", SelectFriendCompany);
    $("body").on("click", "#j_clean_friend_company", CleanSelectFriendCompany);
    $("body").on("click", "#j_determine_friend_company", DetermineSelectFriendCompany);
    $("body").on("input", "#j_friend_search_industry", GetFriendIndustry);
    $("body").on("click", "#j_friend_select_industry .j-industry-span", SelectFriendIndustry);
    $("body").on("click", "#j_clean_friend_industry", CleanSelectFriendIndustry);
    $("body").on("click", "#j_determine_friend_industry", DetermineSelectFriendIndustry);
    $("body").on("input", "#j_friend_search_school", GetFriendSchool);
    $("body").on("click", "#j_friend_select_school .j-school-span", SelectFriendSchool);
    $("body").on("click", "#j_clean_friend_school", CleanSelectFriendSchool);
    $("body").on("click", "#j_determine_friend_school", DetermineSelectFriendSchool);
    ...
    $("body").on("click", "#j_GroupsMember_paging .j-paging", GetGroupsMemberSomePage);
    $("body").on("click", "#j_GroupsMember_paging .j-jump-btn", JumpGroupsMember);
    $("body").on("keydown", "#j_GroupsMember_paging .j-jump", JumpGroupsMemberEnter);
    $("body").on("click", "input[name='selectallGroupsMember']", SelectAllGroupsMember);
    ...
    $("body").on("click", "#j_start_thumbs", startLikes);
...
function CheckLYZC() {
    ...
    if (b == "www.linkedin.cn") {
        $(".j-dialog").remove();
        var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center">' + '<p style="color:#f00; font-size:24px; text-align:center;">您登录的是领英职场，请先登录<a style="font-size:24px;" target="_black" href="http://linkedinjl.com/h?o=usein">领英国际版</a>的界面使用</p>' + "</div>" + "</div>";
...
function InitMember() {
    chrome.storage.sync.get({
        ...
        if (String(a.my_urn)) {
            ...
            $(".j-linkedin img").attr("src", "https://linkedinjl.oss-cn-beijing.aliyuncs.com/expand/version10/img/linkedin.png");
            ...
            $.ajax({
                ...
                success: function(q) {
                    if (q) {
                        ...
                        if (q["included"][0]["picture"] && q["included"][0]["picture"]["rootUrl"]) {
                            var k = q["included"][0]["picture"]["rootUrl"] + q["included"][0]["picture"]["artifacts"][3]["fileIdentifyingUrlPathSegment"]
                        } else {
                            var k = ""
                        }
                        if (p) {
...
function BindLinkedinResult(a) {
    ...
    case 2:
        ...
        if (a["show"]) {
            ...
            JlConfirm("关联失败，一个领英精灵账号最多可关联5个领英，请解绑领英账号再关联");
            $("#j_ok").click(function() {
                GetBind()
            })
        }
...
function ShowBind(d) {
    $(".j-dialog").remove();
    var c = '<div class="j-dialog j-div-center">' + '<div class="j-bind-box j-div-center j-box-sha j-bg-w">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + "</svg>" + "</div>" + "<div>" + "<p>已关联领英</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-bind-cont">';
    for (var b = 0; b < d.length; b++) {
        var a = GetName(d[b]["first_name"], d[b]["last_name"]);
        c += '<div class="j-nowrap j-bind">' + '<div class="j-nowrap">' + '<div><img src="' + d[b]["img"] + '" /></div>' + '<div class="j-bind-name">' + "<div><p>" + a + "</p></div>" + "<div><p>关联时间：" + d[b]["bind_time"] + "</div>" + "</div>" + "</div>";
        if (d[b]["unbind"] == 1) {
            c += '<div class="j-bind-action"><button class="j-unbind j-bg-btn j-btn j-layout-btn" unbind="1" urn=' + d[b]["my_urn"] + ">解绑</button></div>"
        } else {
            c += '<div class="j-bind-action"><button style="background:#ccc;" class="j-unbind j-bg-btn j-btn j-layout-btn" unbind=0 urn=' + d[b]["my_urn"] + ">解绑</button></div>"
        }
        c += "</div>"
    }
    c += '<div class="j-bind-note"><p>*每个领英精灵可关联5个领英账号，关联后1天后可解绑。</p></div>' + "</div>";
    "</div>" + "</div>";
...
function Unbind() {
    ...
    var a = $(this).attr("urn");
    if (b == 1) {
        var c = '<div class="j-dialog j-div-center">' + '<div class="j-confirm-box j-div-center j-box-sha">' + '<div class="j-nowrap">' + '<div class="j-nowrap">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#00f" />' + '<path d="M9 10 A3 3 0 1 1 12 13 l0 3" style="stroke:#fff;" class="j-svg"/>' + '<circle cx="12" cy="18" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<h3>确定</h3>" + "</div>" + "</div>" + '<div class="j-marg"><p>解绑后，该领英账号的分组、备注等会释放，确定要解绑吗？</p></div>' + '<div style="text-align:right;">' + '<button id="j_cancel" class="j-bg-btn j-layout-btn j-close-dialog">取消</button>' + '<button id="j_ok" class="j-bg-btn j-layout-btn j-close-dialog">确定</button>' + "</div>" + "</div>" + "</div>";
        $("#j_lyjl_window").append(c);
        $(".j-dialog").fadeIn(0);
        $("#j_ok").click(function() {
            JlHttp("unbind", a, "", "")
...
function GetInviteQueueResult(c) {
    ...
    if (c) {
        ...
        case 2:
            ...
            $("input[name='selectAllInvite']").prop("checked", false);
            $("#j_inviteQueue_box").empty();
            var b = '<div class="j-explain-box">' + "<p>待加队列中没有可邀请的人，请在精灵搜索人脉、领英推荐人脉、精灵推荐人脉、Groups中将要加的人脉添加到“待加”队列。</p>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
...
function AppendInviteQueue(c) {
    ...
    if (!c["img"]) {
        c["img"] = "https://linkedinjl.oss-cn-beijing.aliyuncs.com/expand/version10/img/me.png"
    }
    var b = '<div class="j-friend j-nowrap" id="i_' + c["urn"] + '" fn="' + c["first_name"] + '" ln="' + c["last_name"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">';
    if (c["public_id"]) {
        b += '<div><a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页">' + '<img src="' + c["img"] + '"></a></div>' + '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>"
    } else {
        b += '<div><img src="' + c["img"] + '"></div>' + '<div class="j-profile">' + '<h3 class="j-oneline" style="color:blue">领英会员</h3>'
    }
    b += '<p class="j-oneline j-posi">' + c["position"] + "</p>" + "</div>" + "</div>" + "<div>";
    if (c["state"] == 2) {
        b += '<input type="checkbox" name="invite">'
    } else {
        b += '<div style="padding-top:16px;"><p>已邀请：' + c["invite_time"] + "</p></div>"
    }
    b += "</div>" + "</div>";
    $("#j_inviteQueue_box").append(b)
}
...
function StartConnectInvite() {
    ...
    if (a == 0) {
        ...
        $("input[name='invite']:checkbox:checked").each(function() {
            var b = {};
            b["urn"] = $.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41);
            ...
            b["img"] = $.trim($(this).parents("div.j-friend").find("img").attr("src"));
            Friend.push(b)
        });
        if (Friend.length > 0) {
            chrome.storage.sync.get({
...
function ConnectInvite() {
    if (Friend.length > 0) {
        Connect(Friend[0]["urn"], Friend[0]["first_name"], Friend[0]["last_name"], Friend[0]["img"], "invite");
        ...
        chrome.storage.sync.get({
            ...
            var b = GetTime(parseInt(a.a_today_num), parseInt(a.a_min_speed), parseInt(a.a_max_speed), a.risk);
            Delayed_time = b;
            DelayedTime();
            Timeout = setTimeout(function() {
                chrome.runtime.sendMessage({
                    action: "loop",
                    result: "connectInvite",
                    other: ""
                }, function(c) {})
            }, b * 1000)
        })
    ...
    if (a["result"] == 1) {
        chrome.storage.sync.get({
            ...
            if (parseInt(b.level) < 1 && parseInt(b.trial) < 1) {
                ShowUpgrade("试用期已过", "试用会员可试用一周，您的试用期已过，请升级会员使用", "立即升级");
                return false
            }
            if (parseInt(b.a_today_num) >= parseInt(b.a_limit)) {
                JlAlert("今天已发" + b.a_today_num + "条邀请，已超设置的每日最多邀请量，请明天再来邀请或在领英精灵界面将每日邀请量设置大些！");
                return false
            }
            switch (a["tag"]) {
            case "invite":
...
function GetMesResult(c) {
    if (c && c["result"] == 1) {
        if (c["data"].length > 0) {
            ...
            PointOut("没有个性邀请消息");
            $("#j_mes_box").empty();
            var b = '<div class="j-explain-box">' + "<p>没有设置个性邀请消息，点击“新增”按钮可以创建个性邀请消息模板。</p>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
            $("#j_mes_box").append(b)
        }
    } else {
        PointOut("获取失败，请尝试刷新页面或重启浏览器")
...
function AppendMes(b) {
    var a = '<div class="j-nowrap j-w j-mes" mid="' + b["mess_id"] + '">' + '<div class="j-mes-cont" title="双击修改内容">' + b["mess"] + "</div>";
    if (parseInt(b["is_select"]) == 1) {
        a += '<div class="j-tidings-select"><input type="checkbox" name="mes" checked=true' + "></div>"
    } else {
        a += '<div class="j-tidings-select"><input type="checkbox" name="mes"></div>'
    }
    a += "</div>" + $("#j_mes_box").append(a)
}
function NewMes() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>新增个性邀请消息</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<textarea id="j_mes" class="j-msg-cont" maxlength=300 placeholder="1.个性化邀请消息会在给对方发送邀请时显示给对方，越短越好，非领英会员不超过200个字符，领英会员不超过300个字符。&#13;&#10;2.可根据对方姓名智能插入姓氏或名字，把光标定位在需要加入姓氏或名字的位置，点击左下角的“插入姓氏”或“插入名字”按钮即可。"></textarea>' + "</div>" + '<div class="j-prompt-ctrl j-nowrap">' + "<div>" + '<button id="j_mes_lastname" class="j-bg-btn j-layout-btn">插入姓氏</button>' + '<button id="j_mes_firstname" style="margin-left:6px;" class="j-bg-btn j-layout-btn">插入名字</button>' + "</div>" + "<div>" + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200);
...
function ResetMes() {
    ...
    $(".j-dialog").remove();
    var c = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>新增个性邀请消息</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<textarea id="j_mes" class="j-msg-cont" maxlength=300 placeholder="1.个性化邀请消息会在给对方发送邀请时显示给对方，越短越好，非领英会员不超过200个字符，领英会员不超过200个字符。&#13;&#10;2.可根据对方姓名智能插入姓氏或名字，把光标定位在需要加入姓氏或名字的位置，点击左下角的“插入姓氏”或“插入名字”按钮即可。">' + a + "</textarea>" + "</div>" + '<div class="j-prompt-ctrl j-nowrap">' + "<div>" + '<button id="j_mes_lastname" class="j-bg-btn j-layout-btn">插入姓氏</button>' + '<button id="j_mes_firstname" class="j-bg-btn j-layout-btn">插入名字</button>' + "</div>" + "<div>" + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(c);
    $(".j-dialog").fadeIn(200);
    $("#j_ok").on("click", function() {
...
function GetConnectCountry() {
    ...
    if (c) {
        ...
        var b = "https://www.linkedin.com/voyager/api/voyagerSearchDashReusableTypeahead?decorationId=com.linkedin.voyager.dash.deco.search.typeahead.ReusableTypeaheadCollection-28&keywords=" + encodeURIComponent(c) + "&q=type&query=(typeaheadFilterQuery:(geoSearchTypes:List(MARKET_AREA,COUNTRY_REGION,ADMIN_DIVISION_1,CITY)))&type=GEO";
        $.ajax({
            url: b,
            type: "get",
            headers: {
                ...
                if (j) {
                    ...
                    if (e > 0) {
                        for (var f = 0; f < e; f++) {
                            ...
                            var g = "<div>" + '<span class="j-country-span" urn="' + k + '">' + l + "</span>" + "</div>";
...
function SelectConnectCountry() {
    ...
    var a = "<li>" + '<input type="checkbox" name="connectcountry" checked="checked" value="' + b + '">' + "<span>" + c + "</span>" + "</li>";
    $("#j_connect_country").append(a)
}
function CleanSelectConnectCountry() {
    $("#j_connect_country").empty();
    var a = "<li>" + '<input type="checkbox" name="connectcountry" value="102890883">' + "<span> 中国</span>" + "</li>" + "<li>" + '<input type="checkbox" name="connectcountry" value="103644278">' + "<span> 美国</span>" + "</li>";
    $("#j_connect_country").append(a);
...
function GetConnectMutual() {
    ...
    if (c) {
        ...
        var b = "https://www.linkedin.com/voyager/api/voyagerSearchDashReusableTypeahead?decorationId=com.linkedin.voyager.dash.deco.search.typeahead.ReusableTypeaheadCollection-28&keywords=" + encodeURIComponent(c) + "&q=type&query=(typeaheadFilterQuery:(geoSearchTypes:List(MARKET_AREA,COUNTRY_REGION,ADMIN_DIVISION_1,CITY)))&type=CONNECTIONS";
        $.ajax({
            url: b,
            type: "get",
            headers: {
                ...
                if (j) {
                    ...
                    if (h.length > 0) {
                        for (var f = 0; f < h.length; f++) {
                            ...
                            if (h[f]["image"]["attributes"][0]["detailDataUnion"] && h[f]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"] && h[f]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"] && h[f]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["rootUrl"]) {
                                e["img"] = h[f]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["rootUrl"] + h[f]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                            } else {
                                e["img"] = ""
                            }
                            var g = '<div class="j-nowrap-left j-mutual-span" title="点击选择" urn="' + e["urn"] + '" na="' + e["name"] + '">' + '<div class="j-mutual-img"><img src="' + e["img"] + '"></div>' + '<div style="width:252px;">' + '<h3 class="j-oneline">' + e["name"] + "</h3>" + '<p class="j-oneline">' + e["position"] + "</p>" + "</div>" + "</div>";
...
function SelectConnectMutual() {
    ...
    var b = "<li>" + '<input type="checkbox" name="connectmutual" checked="checked" value="' + c + '">' + "<span>" + a + "</span>" + "</li>";
...
function GetConnectIndustry() {
    ...
    var a = "urn:li:page:d_flagship3_search_srp_people;" + randomString(22) + "==";
    if (d && b) {
        if (isChinese(d)) {
            var e = "zh_CN"
        } else {
        ...
        var c = "https://www.linkedin.com/voyager/api/voyagerSearchDashReusableTypeahead?decorationId=com.linkedin.voyager.dash.deco.search.typeahead.ReusableTypeaheadCollection-28&keywords=" + d + "&q=type&query=(typeaheadFilterQuery:(standardizationEntityType:industry))&type=INDUSTRY";
        $.ajax({
            url: c,
            type: "get",
            headers: {
                ...
                if (l) {
                    ...
                    if (f > 0) {
                        for (var g = 0; g < f; g++) {
                            ...
                            var j = "<div>" + '<span class="j-industry-span" urn="' + m + '">' + h + "</span>" + "</div>";
...
function SelectConnectIndustry() {
    ...
    var b = "<li>" + '<input type="checkbox" name="connectindustry" checked="checked" value="' + c + '">' + "<span> " + a + "</span>" + "</li>";
    $("#j_connect_industry").append(b)
}
function CleanSelectConnectIndustry() {
    $("#j_connect_industry").empty();
    var a = "<li>" + '<input type="checkbox" name="connectindustry" value="6">' + "<span> 互联网</span>" + "</li>" + "<li>" + '<input type="checkbox" name="connectindustry" value="11">' + "<span> 电器/电子制造</span>" + "</li>";
...
function GetConnectCompany() {
    ...
    if (d && b) {
        ...
        var c = "https://www.linkedin.com/voyager/api/voyagerSearchDashReusableTypeahead?decorationId=com.linkedin.voyager.dash.deco.search.typeahead.ReusableTypeaheadCollection-28&keywords=" + d + "&q=type&query=()&type=COMPANY";
        $.ajax({
            url: c,
            type: "get",
            headers: {
                ...
                if (l) {
                    ...
                    if (f > 0) {
                        for (var g = 0; g < f; g++) {
                            ...
                            var h = "<div>" + '<span class="j-company-span" urn="' + m + '">' + j + "</span>" + "</div>";
...
function SelectConnectCompany() {
    ...
    var a = "<li>" + '<input type="checkbox" name="connectcompany" checked="checked" value="' + c + '">' + "<span> " + b + "</span>" + "</li>";
    $("#j_connect_company").append(a)
}
function CleanSelectConnectCompany() {
    $("#j_connect_company").empty();
    var a = "<li>" + '<input type="checkbox" name="connectcompany" value="14160">' + "<span> 阿里巴巴</span>" + "</li>" + "<li>" + '<input type="checkbox" name="connectcompany" value="3014">' + "<span> 华为</span>" + "</li>";
    $("#j_connect_company").append(a);
...
function GetConnectSchool() {
    ...
    if (d && b) {
        ...
        var c = "https://www.linkedin.com/voyager/api/graphql?variables=(keywords:" + d + ",query:(),type:SCHOOL)&queryId=voyagerSearchDashReusableTypeahead.23c9f700d1a32edbb7f6646dda5e7480";
        $.ajax({
            url: c,
            type: "get",
            headers: {
            ...
            success: function(l) {
                if (l) {
                    var k = l["data"]["data"]["searchDashReusableTypeaheadByType"]["elements"];
                    var f = k.length;
                    if (f > 0) {
                        for (var h = 0; h < f; h++) {
                            var m = k[h]["trackingUrn"].slice(19);
                            var g = k[h]["title"]["text"];
                            var j = "<div>" + '<span class="j-school-span" urn="' + m + '">' + g + "</span>" + "</div>";
...
function SelectConnectSchool() {
    ...
    var b = "<li>" + '<input type="checkbox" name="connectschool" checked="checked" value="' + c + '">' + "<span> " + a + "</span>" + "</li>";
    $("#j_connect_school").append(b)
}
function CleanSelectConnectSchool() {
    $("#j_connect_school").empty();
    var a = "<li>" + '<input type="checkbox" name="connectschool" value="20289">' + "<span> 北京大学</span>" + "</li>" + "<li>" + '<input type="checkbox" name="connectschool" value="14022">' + "<span> 清华大学</span>" + "</li>";
...
function GetConnect(a) {
    chrome.storage.sync.get({
        ...
        var b = "https://www.linkedin.com/voyager/api/graphql?variables=(start:" + d + ",origin:FACETED_SEARCH,query:(" + j + "&&queryId=voyagerSearchDashClusters.a3ebd8258d1b429e3d95ff512f377687";
        ...
        $.ajax({
            ...
            success: function(v) {
                ...
                if (v["data"]["data"]["searchDashClustersByAll"]["elements"]) {
                    ...
                    for (var w = 0; w < x.length; w++) {
                        for (var u = 0; u < x[w]["items"].length; u++) {
                            if (x[w]["items"][u]["$type"] == "com.linkedin.voyager.dash.search.SearchItem" && x[w]["items"][u]["item"]["*entityResult"] && x[w]["items"][u]["item"]["*entityResult"].substr(0, 53) == "urn:li:fsd_entityResultViewModel:(urn:li:fsd_profile:") {
                                q.push(x[w]["items"][u]["item"]["*entityResult"].substr(53, 39))
                            }
                        }
                    }
                } else {
                    var t = '<div class="j-explain-box">' + "<p>没有搜索到人脉，请切换关键词或过滤条件。</p>" + '<a href="http://linkedinjl.com/help?o=addfriend" target="_black">查看详细教程</a>' + "</div>";
                    $("#j_connect_box").append(t);
                    ShowPaging("j_connect_paging", 1, 0, 10);
                    PointOut("没有搜索到人脉，请切换关键词或过滤条件。")
                }
                if (v["data"]["data"]["searchDashClustersByAll"]["metadata"]["totalResultCount"]) {
                    var r = v["data"]["data"]["searchDashClustersByAll"]["metadata"]["totalResultCount"]
                } else {
                    var t = '<div class="j-explain-box">' + "<p>没有搜索到人脉，请切换关键词或过滤条件。</p>" + '<a href="http://linkedinjl.com/help?o=addfriend" target="_black">查看详细教程</a>' + "</div>";
                    $("#j_connect_box").append(t);
                    ShowPaging("j_connect_paging", 1, 0, 10);
                ...
                if (v["data"]["data"]["searchDashClustersByAll"]["paging"]) {
                    var z = v["data"]["data"]["searchDashClustersByAll"]["paging"]["total"]
                } else {
                    var z = 0
                }
                ...
                for (var w = 0; w < q.length; w++) {
                    for (var u = 0; u < y.length; u++) {
                        if (y[u]["$type"] == "com.linkedin.voyager.dash.search.EntityResultViewModel" && y[u]["entityUrn"].substr(53, 39) == q[w]) {
                            var A = {};
                            A["urn"] = q[w];
                            p += A["urn"] + ",";
                            ...
                            if (y[u]["navigationUrl"] && s.test(y[u]["navigationUrl"])) {
                                ...
                                A["public_id"] = decodeURIComponent(y[u]["navigationUrl"].split("?")[0].substr(28))
                            } else {
                                A["name"] = "领英会员";
                                A["first_name"] = "";
                                A["last_name"] = "";
                            ...
                            if (y[u]["image"] && y[u]["image"]["attributes"] && y[u]["image"]["attributes"][0] && y[u]["image"]["attributes"][0]["detailData"] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0] && y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]) {
                                A["img"] = y[u]["image"]["attributes"][0]["detailData"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                            } else {
                                A["img"] = ""
                            }
                            B.push(A)
                                ...
                                for (var D = 0; D < B.length; D++) {
                                    for (var C = 0; C < E.length; C++) {
                                        if (B[D]["urn"] == E[C]["entityUrn"].split(":")[3]) {
                                            if (E[C]["primaryAction"] && E[C]["primaryAction"]["action"]) {
                                                B[D]["action"] = E[C]["primaryAction"]["action"]["$type"].split(".")[6]
                                            } else {
                                                B[D]["action"] != ""
                                            }
                                        }
...
function AppendConnectToTable(b) {
    var a = '<div class="j-friend j-nowrap" id="c_' + b["urn"] + '" fn="' + b["first_name"] + '" ln="' + b["last_name"] + '" pid="' + b["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">';
    if (b["public_id"]) {
        a += '<div><a href="https://www.linkedin.com/in/' + b["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + b["img"] + '"></a></div>'
    } else {
        a += '<div><img src="' + b["img"] + '"></div>'
    }
    a += '<div class="j-profile">' + '<div class="j-nowrap-left">' + '<h3 class="j-oneline">' + b["name"] + "</h3>" + '<span class="j-distance">' + b["distance"] + "</span>" + "</div>" + '<p class="j-oneline j-posi">' + b["position"] + "</p>" + "</div>" + "</div>" + "<div>";
    switch (b["action"]) {
    case "Connect":
    case "SendInMail":
    case "Follow":
...
function GetSearchRecommResult(c) {
    if (c && c["result"] == 1) {
        if (c["page"] == 1) {
            var b = '<div style="color:#ccc; text-align:center; padding:12px;">----------  您的领英账号达到这个月的搜索上限，以下是推荐的人脉  ----------</div>';
...
function AppendSearchRecomm(c) {
    var a = GetName(c["first_name"], c["last_name"]);
    var b = '<div class="j-friend j-nowrap" id="c_' + c["urn"] + '" fn="' + c["first_name"] + '" ln="' + c["last_name"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">';
    if (c["public_id"]) {
        b += '<div><a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + c["img"] + '"></a></div>'
    } else {
        b += '<div><img src="' + c["img"] + '"></div>'
    }
    b += '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline j-posi">' + c["position"] + "</p>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name="connect">' + "</div>" + "</div>";
    $("#j_connect_box").append(b)
}
...
function StartConnectSearch() {
    ...
    if (a == 0) {
        ...
        $("input[name='connect']:checkbox:checked").each(function() {
            ...
            b["public_id"] = $.trim($(this).parents("div.j-friend").attr("pid"));
            b["img"] = $.trim($(this).parents("div.j-friend").find("img").attr("src"));
            b["position"] = $.trim($(this).parents("div.j-friend").find(".j-posi").text());
            Friend.push(b)
        });
        if (Friend.length > 0) {
            chrome.storage.sync.get({
...
function AddInviteSearch() {
    ...
    if (b == 0) {
        ...
        $("input[name='connect']:checkbox:checked").each(function() {
            var c = {};
            c["urn"] = $.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41);
            ...
            c["img"] = $.trim($(this).parents("div.j-friend").find("img").attr("src"));
            c["position"] = $.trim($(this).parents("div.j-friend").find(".j-posi").text());
            a.push(c)
        });
        if (a.length > 0) {
            a = JSON.stringify(a);
...
function ConnectSearch() {
    if (Friend.length > 0) {
        Connect(Friend[0]["urn"], Friend[0]["first_name"], Friend[0]["last_name"], Friend[0]["img"], "Search");
        ...
        chrome.storage.sync.get({
            ...
            var d = GetTime(parseInt(c.a_today_num), parseInt(c.a_min_speed), parseInt(c.a_max_speed), c.risk);
            Delayed_time = d;
            DelayedTime();
            Timeout = setTimeout(function() {
                chrome.runtime.sendMessage({
                    action: "loop",
                    result: "connectSearch",
                    other: ""
                }, function(e) {})
            }, d * 1000)
        })
...
function GetLyComm() {
    ...
    var b = "https://www.linkedin.com/voyager/api/relationships/discovery?count=12&paginationToken=1214007020&q=cohort&reasons=List((sourceType:PYMK_ENTITY,reasonContext:PYMK_ENTITY))&start=" + d;
    $.ajax({
        url: b,
        type: "get",
        headers: {
        ...
        success: function(m) {
            if (m["data"] && m["included"] && m["data"]["*elements"]) {
                ...
                if (parseInt(c) == 0) {
                    $("#j_lyComm_box").empty();
                    PointOut("没有推荐的人");
                    var k = '<div class="j-explain-box">' + "<p>没有推荐的人<p/>" + '<a href="http://linkedinjl.com/help?o=addfriend" target="_black">查看详细教程</a>' + "</div>";
                ...
                for (var h = 0; h < l.length; h++) {
                    ...
                    for (var g = 0; g < n.length; g++) {
                        if (n[g]["$type"] == "com.linkedin.voyager.identity.shared.MiniProfile" && n[g]["entityUrn"].substr(22) == e["urn"]) {
                            ...
                            if (n[g]["picture"] && n[g]["picture"]["artifacts"] && n[g]["picture"]["rootUrl"]) {
                                e["img"] = n[g]["picture"]["rootUrl"] + n[g]["picture"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                            } else {
                                e["img"] = ""
                            }
                        }
...
function AppendLyComm(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id="y_' + c["urn"] + '" fn="' + c["first_name"] + '" ln="' + c["last_name"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">';
    if (c["public_id"]) {
        b += '<div><a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页">' + '<img src="' + c["img"] + '"></a></div>'
    } else {
        b += '<div><img src="' + c["img"] + '"></div>'
    }
    b += '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline j-posi">' + c["position"] + "</p>" + "</div>" + "</div>" + "<div>";
...
function ConnectLyComm() {
    if (Friend.length > 0) {
        Connect(Friend[0]["urn"], Friend[0]["first_name"], Friend[0]["last_name"], Friend[0]["img"], "lyComm");
...
function AppendJlComm(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id="j_' + c["urn"] + '" fn="' + c["first_name"] + '" ln="' + c["last_name"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">';
    if (c["public_id"]) {
        b += '<div><a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页">' + '<img src="' + c["img"] + '"></a></div>'
    } else {
        b += '<div><img src="' + c["img"] + '"></div>'
...
function ConnectJlComm() {
    if (Friend.length > 0) {
        Connect(Friend[0]["urn"], Friend[0]["first_name"], Friend[0]["last_name"], Friend[0]["img"], "JlComm");
...
function Connect(b, e, d, c, a) {
    chrome.storage.sync.get({
        ...
        if (parseInt(h.level) < 1 && parseInt(h.a_today_num) >= TestCount) {
            StopAction();
            setTimeout(function() {
                if (confirm("今日试用名额已用完。您是试用会员，试用会员每天有" + TestCount + "个试用名额，升级会员不受此限制。")) {
                    Upgrade()
                }
            }, 50);
            return false
        ...
        if (parseInt(h.a_today_num) >= parseInt(h.a_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今天邀请量已过设置的最大量，请明天来加或在精灵设置里把每日邀请量设置大些。")
            }, 50);
            return false
        }
        ...
        var i = "/voyager/api/voyagerRelationshipsDashMemberRelationships?action=verifyQuotaAndCreate";
        $.ajax({
            url: i,
            type: "post",
            ...
            success: function(l) {
                ...
                if (k > 100) {
                    $("#j_today_count").html('<font style="color:#f00;">今日已加：' + k + "人</font>")
                } else {
...
function GetLineResult(c) {
    if (c) {
        ...
        case 2:
            $("#j_lineAdd_box").empty();
            var b = '<div class="j-explain-box">' + "<p>链接加人，只需要对方的主页链接即可加为好友。通过对方链接加人时不会智能插入对方称呼，所以在设置邀请消息模板时要区分开。</p>" + '<a href="http://linkedinjl.com/help?o=addfriend" target="_black">查看详细教程</a>' + "</div>";
...
function AppendLine(b) {
    var a = '<div id="l_' + b["id"] + '" class="j-line-box j-nowrap" ws="' + b["websites"] + '">' + '<div class="j-nowrap">' + '<p class="j-oneline">https://www.linkedin.com/in/' + b["websites"] + "</p>" + '<a style="margin-left:36px;" href="https://www.linkedin.com/in/' + b["websites"] + '" target="_black">查看主页</a>' + "</div>" + "<div>" + '<input type="checkbox" name="lineAdd">' + "</div>" + "</div>";
    $("#j_lineAdd_box").append(a)
}
function NewLine() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>新增链接人脉</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<div calss="j-w">' + '<textarea id="j_line" class="j-line-cont" placeholder="网址要求：&#13;&#10;1.一行一条&#13;&#10;2.网址一定要是对方主页的地址&#13;&#10;3.一次最多添加1000条&#13;&#10;&#13;&#10;例：&#13;&#10;https://www.linkedin.com/in/kai-tai-askwx3611a&#13;&#10;https://www.linkedin.com/in/kai-wang-a473611a&#13;&#10;https://www.linkedin.com/in/志强-胡&#13;&#10;"></textarea>' + "</div>" + "</div>" + '<div class="j-prompt-ctrl">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200);
    $("#j_ok").on("click", function() {
        ...
        for (var d = 0; d < b.length; d++) {
            if (b[d]) {
                ...
                if (e.test(b[d])) {
                    b[d] = $.trim(b[d]).replace(/^http[s]*:\/\/[www.]*linkedin.com\/in\//g, "");
                    b[d] = b[d].replace("/", "");
                    b[d] = b[d].replace(",", "");
                    b[d] = b[d].replace("，", "");
                    c.push(b[d])
...
function StartConnectLine() {
    chrome.storage.sync.get({
        ...
        if (parseInt(a.a_today_num) >= parseInt(a.a_limit)) {
            JlAlert("今天已发" + a.a_today_num + "条邀请，已超设置的每日最多邀请量，请明天再来邀请或在领英精灵界面将每日邀请量设置大些！");
            return false
        }
        Friend = [];
        $("input[name='lineAdd']:checkbox:checked").each(function() {
    ...
    chrome.storage.sync.get({
        ...
        $.ajax({
            ...
            success: function(i) {
                ...
                $("#j_action_count").text("本次已加：" + ActionCount + "人");
                if (h > 100) {
                    $("#j_today_count").html('<font style="color:#f00;">今日已加：' + h + "人</font>")
                } else {
        ...
        var e = GetTime(parseInt(c.a_today_num), parseInt(c.a_min_speed), parseInt(c.a_max_speed), c.risk);
        Delayed_time = e;
        DelayedTime();
        Timeout = setTimeout(function() {
            Friend.shift();
                        ...
                        if (g > 0) {
                            ...
                            $.ajax({
                                ...
                                success: function(s) {
                                    ...
                                    if (s && s["data"] && s["data"]["*elements"] && s["included"]) {
                                        $("#j_recall_box").empty();
                                        ...
                                        if (r.length > 0) {
                                            ...
                                            for (var o = 0; o < r.length; o++) {
                                                ...
                                                for (var n = 0; n < q.length; n++) {
                                                    if (q[n]["$type"] == "com.linkedin.voyager.relationships.invitation.Invitation" && q[n]["entityUrn"].split(":")[3] == m["invite_urn"]) {
                                                        m["urn"] = q[n]["toMemberId"];
                                                        m["sentTime"] = q[n]["sentTime"];
                                                        for (var l = 0; l < q.length; l++) {
                                                            if (q[l]["$type"] == "com.linkedin.voyager.identity.shared.MiniProfile" && q[l]["entityUrn"].split(":")[3] == m["urn"]) {
                                                                m["firstName"] = q[l]["firstName"];
                                                                m["lastName"] = q[l]["lastName"];
                                                                m["position"] = q[l]["occupation"];
                                                                m["publicId"] = q[l]["publicIdentifier"];
                                                                if (q[l]["picture"] && q[l]["picture"]["rootUrl"] && q[l]["picture"]["artifacts"] && q[l]["picture"]["artifacts"][0]) {
                                                                    m["img"] = q[l]["picture"]["rootUrl"] + q[l]["picture"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                                                                } else {
                                                                    m["img"] = "http://linkedinjl.com/expand/version1/img/me.png"
                                                                }
                                                                break
                                                            }
                                                        }
                                        ...
                                        $("#j_recall_box").empty();
                                        var p = '<div class="j-explain-box j-w">' + "<p>您没有未通过的邀请。</p>" + '<a href="http://linkedinjl.com/help?o=recall" target="_black">查看详细教程</a>' + "</div>";
...
function AppendRecallToTable(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id="r_' + c["invite_urn"] + '">' + '<div class="j-profile-box j-nowrap-left">' + '<div><a href="/in/' + c["publicId"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + c["img"] + '"></a></div>' + '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline">' + c["position"] + "</p>" + '<p class="j-oneline j-remark">' + c["sentTime"] + "</p>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name="recall">';
    "</div>" + "</div>";
    ...
    chrome.storage.sync.get({
        ...
        $("#j_ok").on("click", function() {
            ...
            $("input[name='recall']:checkbox:checked").each(function() {
                var h = {};
                h["entityUrn"] = "urn:li:fs_relInvitation:" + $.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41);
...
function SaveRecallRecordResult(a) {
    if (a && a["result"]) {
        ...
        case 6:
            ...
            break;
        case 7:
            ShowUpgrade("试用期已过", "注册后可以试用1周，您的试用期已过，升级会员可继续使用，感谢支持");
            break;
        default:
            break
        }
...
function StartConnectLinkedin() {
    chrome.storage.sync.get({
        ...
        var d = '<div class="j-dialog j-div-center j-close-dialog">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha" style="width:260px; text-align:center;">' + '<div style="margin:24px">' + "<p>自动加好友前，请先在领英页面搜索出要加的人</p>" + '<div style="margin:12px;">' + '<a href=\'/search/results/people/?network=%5B"S"%2C"O"%5D\'>前往领英搜索人脉</a></div>' + "</div>" + "</div>" + "</div>";
...
function ConnectLinkedin() {
    chrome.storage.sync.get({
        ...
        if (parseInt(j.a_today_num) >= parseInt(j.a_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计发送 " + parseInt(j.a_today_num) + " 条邀请，已超设置的每日最多邀请量，请明天再来邀请或在领英精灵界面将每日邀请量设置大些！")
            }, 50);
            return false
        }
        if ($("ul.reusable-search__entity-result-list li.reusable-search__result-container").length > 0) {
            var l = $("ul.reusable-search__entity-result-list li.reusable-search__result-container:first");
            if (l.length > 0) {
                if ($("ul.reusable-search__entity-result-list li.reusable-search__result-container").length % 4) {
                    $("html, body").animate({
                        scrollTop: "0px"
                    }, 1000)
                } else {
                ...
                if (c.length > 0) {
                    ...
                    if (!c.prop("disabled") && (h == "加为好友" || h == "Connect" || h == "建立關係" || h == "发消息" || h == "Message" || h == "訊息")) {
                        var f = $.trim(ArrangeFid(decodeURIComponent(l.find("span.entity-result__title-text.t-16 a").attr("href").split("?")[0])));
                        var i = $.trim(l.find("img:first").attr("src"));
                        var b = $.trim(l.find("span.entity-result__title-text.t-16 span span:first").text());
                        ...
                        $.ajax({
                            ...
                            success: function(q) {
                                ...
                                $("#j_action_count").text("本次已加：" + ActionCount + "人");
                                if (p > 100) {
                                    $("#j_today_count").html('<font style="color:#f00;">今日已加：' + p + "人</font>")
                                } else {
                        ...
                        var e = GetTime(parseInt(j.a_today_num), parseInt(j.a_min_speed), parseInt(j.a_max_speed), j.risk);
                        Delayed_time = e;
                        DelayedTime();
                        Timeout = setTimeout(function() {
                            l.remove();
            ...
            var l = $("ul.search-results__list li.search-result__occluded-item:first");
            if (l.length < 1) {
                if ($(".artdeco-pagination__button--next").length > 0 && !$(".artdeco-pagination__button--next").prop("disabled")) {
                    $(".artdeco-pagination__button--next").click();
                    Timeout = setTimeout(function() {
            ...
            if (c.length > 0 && c.attr("data-control-name") == "srp_profile_actions" && !c.prop("disabled")) {
                var f = $.trim(ArrangeFid(decodeURIComponent(l.find("span.entity-result__title-text.t-16 a").attr("href").split("?")[0])));
                var i = $.trim(l.find("img:first").attr("src"));
...
function StartConnectSales() {
    ...
    a += "&start=" + b + "&count=25" + "&trackingParam=(sessionId:" + d + ")&decorationId=com.linkedin.sales.deco.desktop.searchv2.LeadSearchResult-9";
            ...
            if (m) {
                ...
                for (var k = 0; k < l.length; k++) {
                    if (l[k]["pendingInvitation"] == false && l[k]["degree"] != 1) {
                        ...
                        if (l[k]["profilePictureDisplayImage"] && l[k]["profilePictureDisplayImage"]["rootUrl"] && l[k]["profilePictureDisplayImage"]["artifacts"]) {
                            j["img"] = l[k]["profilePictureDisplayImage"]["rootUrl"] + l[k]["profilePictureDisplayImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                        } else {
                            j["img"] = ""
                        }
                        Friend.push(j)
...
function ConnectSales() {
    ...
    chrome.storage.sync.get({
        ...
        var d = "https://www.linkedin.com/sales-api/salesApiConnection?action=connectV2";
        $.ajax({
            url: d,
            type: "post",
            data: JSON.stringify(a),
            ...
            success: function(h) {
                ...
                $("#j_action_count").text("本次已加：" + ActionCount + "人");
                if (g > 100) {
                    $("#j_today_count").html('<font style="color:#f00;">今日已加：' + g + "人</font>")
                } else {
...
function GetFriendForSales(h) {
    ...
    b += "&start=" + h + "&count=25" + "&trackingParam=(sessionId:" + g + ")&decorationId=com.linkedin.sales.deco.desktop.searchv2.LeadSearchResult-9";
    var a = getCookie("JSESSIONID");
    if (!a) {
        PointOut("请确保领英账号已正常登录，请尝试刷新领英页面。");
        return false
...
function GetFriendForAll(c, e) {
    ...
    var b = "/voyager/api/relationships/dash/connections?count=40&decorationId=com.linkedin.voyager.dash.deco.web.mynetwork.ConnectionListWithProfile-15&q=search&sortType=RECENTLY_ADDED&start=" + d;
    $.ajax({
        url: b,
        type: "get",
        headers: {
        ...
        success: function(f) {
            chrome.storage.sync.get({
                ...
                if (f && f["data"]["*elements"] && f["included"]) {
                    ...
                    if (q == 0) {
                        var h = '<div class="j-explain-box">' + "<p>没有匹配的人脉，请切换关键词或过滤条件。<p/>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
                    ...
                    for (var n = 0; n < g.length; n++) {
                        ...
                        for (var m = 0; m < o.length; m++) {
                            if (o[m]["$type"] == "com.linkedin.voyager.dash.identity.profile.Profile" && o[m]["entityUrn"].split(":")[3] == r["urn"]) {
                                ...
                                if (o[m]["profilePicture"] && o[m]["profilePicture"]["displayImageReference"] && o[m]["profilePicture"]["displayImageReference"]["vectorImage"] && o[m]["profilePicture"]["displayImageReference"]["vectorImage"]["rootUrl"]) {
                                    r["img"] = o[m]["profilePicture"]["displayImageReference"]["vectorImage"]["rootUrl"] + o[m]["profilePicture"]["displayImageReference"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                                } else {
                                    r["img"] = ""
                                }
...
function GetFriendForSearch(e, l) {
    ...
    var a = "https://www.linkedin.com/voyager/api/search/dash/clusters?decorationId=com.linkedin.voyager.dash.deco.search.SearchClusterCollection-161&origin=FACETED_SEARCH&q=all&query=(" + f + "&start=" + b;
    chrome.storage.sync.get({
        my_urn: ""
    }, function(n) {
        ...
        $.ajax({
            ...
            headers: {
                ...
                "x-restli-protocol-version": "2.0.0",
                "x-li-lang": c,
                "x-li-page-instance": "urn:li:page:d_flagship3_search_srp_people_load_more;GToX++oWQU+AxjzOpfsgLg=="
            },
            success: function(u) {
                if (u) {
                    PointOut("获取成功", 1);
                    ...
                    if (t == 0) {
                        var s = '<div class="j-explain-box j-w">' + '<p style="text-align:center">没有匹配的好友,请切换搜索条件</p>' + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
                    ...
                    for (var q = 0; q < w.length; q++) {
                        if (w[q]["$type"] && w[q]["$type"] == "com.linkedin.voyager.dash.search.EntityResultViewModel") {
                            var p = {};
                            ...
                            if (w[q]["image"] && w[q]["image"]["attributes"] && w[q]["image"]["attributes"][0]["detailDataUnion"] && w[q]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"] && w[q]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"] && w[q]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"] && w[q]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]) {
                                p["img"] = w[q]["image"]["attributes"][0]["detailDataUnion"]["nonEntityProfilePicture"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                            } else {
                                p["img"] = ""
                            }
                            if (p["urn"] != o) {
...
function AppendFriendToTable(c) {
    var a = GetName(c.first_name, c.last_name);
    var b = '<div class="j-friend j-nowrap" id="f_' + c["urn"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">' + '<div><a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + c["img"] + '"></a></div>' + '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline">' + c["position"] + "</p>" + '<p class="j-oneline"></p>' + '<div class="j-nowrap-left">' + '<div class="j-edit j-svg-ico18" title="修改备注">' + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M3 15 l12 0" class="j-svg"/>' + '<path d="M3 14 l2 -4 l5 -5 l2 2 l-5 5 z" class="j-svg-bg" />' + '<path d="M12 4 l1 -1 l1 1 l-1 1 z" class="j-svg" />' + "</svg>" + "</div>" + '<div><p class="j-oneline j-remark"></p></div>' + "</div>" + "</div>" + "</div>" + '<div class="j-tool-box">' + '<p class="j-grouping j-oneline" title="分组">未分组</p>' + '<p class="j-sendtime j-oneline" title="通过领英精灵最后一次群发日期">群发：未群发过</p>' + '<div class="j-nowrap-left">' + '<div class="j-dig j-svg-ico18" state=0 title="未挖掘，点击挖掘">' + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1">' + '<circle cx="9" cy="9" r="3" class="j-svg-0" />' + '<path d="M2 9 Q9 2 16 9" class="j-svg-0" />' + '<path d="M2 9 Q9 16 16 9" class="j-svg-0" />' + "</svg>" + "</div>" + '<div class="j-prohibit j-svg-ico18" state=0 title="未在禁发名单，点击加入">' + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="9" cy="9" r="5" class="j-svg-0" />' + '<path d="M5 5 l8 8" class="j-svg-0" />' + "</svg>" + "</div>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name="friend">' + "</div>" + "</div>";
    ...
    if (b && b["result"] == 1) {
        for (var a = 0; a < b["data"].length; a++) {
            if (b["data"][a]["send_time"] == null) {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-sendtime").text("群发：未群发过")
            } else {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-sendtime").html('<font style="color:#f00;">群发：' + b["data"][a]["send_time"] + "</font>")
            }
            $("#f_" + b["data"][a]["friend_urn"]).find(".j-remark").text(b["data"][a]["remark"]);
            $("#f_" + b["data"][a]["friend_urn"]).find(".j-remark").attr("title", b["data"][a]["remark"]);
            if (b["data"][a]["group_name"] == null) {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-grouping").text("未分组");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-grouping").attr("grouping", 0)
            } else {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-grouping").html('<h3 class="j-oneline">' + b["data"][a]["group_name"] + "</h3>");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-grouping").attr("grouping", 1)
            }
            if (b["data"][a]["is_prohibit"] == "1") {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-prohibit svg *").addClass("j-svg-1");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-prohibit svg *").removeClass("j-svg-0");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-prohibit").attr("title", "已在禁发名单，点击移出");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-prohibit").attr("state", "1")
            }
            if (b["data"][a]["dig_state"] == "1") {
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-dig svg *").addClass("j-svg-1");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-dig svg *").removeClass("j-svg-0");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-dig").attr("title", "已挖掘，点击查看详情");
                $("#f_" + b["data"][a]["friend_urn"]).find(".j-dig").attr("state", "1")
            }
        }
    } else {
        PointOut("精灵同步失败")
...
function SelectFriendCountry() {
    ...
    var a = "<li>" + '<input type="checkbox" name="friendcountry" checked="checked" value="' + b + '">' + "<span>" + c + "</span>" + "</li>";
    $("#j_friend_country").append(a)
}
function CleanSelectFriendCountry() {
    $("#j_friend_country").empty();
    var a = "<li>" + '<input type="checkbox" name="friendcountry" value="102890883">' + "<span> 中国</span>" + "</li>" + "<li>" + '<input type="checkbox" name="friendcountry" value="103644278">' + "<span> 美国</span>" + "</li>";
    $("#j_friend_country").append(a);
...
function SelectFriendCompany() {
    ...
    var a = "<li>" + '<input type="checkbox" name="friendcompany" checked="checked" value="' + c + '">' + "<span> " + b + "</span>" + "</li>";
    $("#j_friend_company").append(a)
}
function CleanSelectFriendCompany() {
    $("#j_friend_company").empty();
    var a = "<li>" + '<input type="checkbox" name="friendcompany" value="14160">' + "<span> 阿里巴巴</span>" + "</li>" + "<li>" + '<input type="checkbox" name="friendcompany" value="3014">' + "<span> 华为</span>" + "</li>";
    $("#j_friend_company").append(a);
...
function SelectFriendIndustry() {
    ...
    var b = "<li>" + '<input type="checkbox" name="friendindustry" checked="checked" value="' + c + '">' + "<span> " + a + "</span>" + "</li>";
    $("#j_friend_industry").append(b)
}
function CleanSelectFriendIndustry() {
    $("#j_friend_industry").empty();
    var a = "<li>" + '<input type="checkbox" name="friendindustry" value="6">' + "<span> 互联网</span>" + "</li>" + "<li>" + '<input type="checkbox" name="friendindustry" value="11">' + "<span> 电器/电子制造</span>" + "</li>";
...
function SelectFriendSchool() {
    ...
    var b = "<li>" + '<input type="checkbox" name="friendschool" checked="checked" value="' + c + '">' + "<span> " + a + "</span>" + "</li>";
    $("#j_friend_school").append(b)
}
function CleanSelectFriendSchool() {
    $("#j_friend_school").empty();
    var a = "<li>" + '<input type="checkbox" name="friendschool" value="20289">' + "<span> 北京大学</span>" + "</li>" + "<li>" + '<input type="checkbox" name="friendschool" value="14022">' + "<span> 清华大学</span>" + "</li>";
...
function ShowGroupingDialog(b, a) {
    ...
    chrome.storage.sync.get({
        ...
        var e = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-box-sha j-bg-w" style="width:40%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#00f" />' + '<path d="M9 10 A3 3 0 1 1 12 13 l0 3" style="stroke:#fff;" class="j-svg"/>' + '<circle cx="12" cy="18" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>分组到...</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<div><select id="j_select_group" style="padding:6px; width:90%;">';
        for (var d = 0; d < b.length; d++) {
            if (b[d]["group_id"] == a) {
                e += '<option selected="selected" value=' + b[d]["group_id"] + ">" + b[d]["group_name"] + "</option>"
            } else {
                e += "<option value=" + b[d]["group_id"] + ">" + b[d]["group_name"] + "</option>"
            }
        }
        e += "<option value=0>移出分组</option>";
        e += "</select></div>" + "</div>" + '<div class="j-prompt-ctrl j-nowrap" style="width:90%;">' + "<div>" + '<input id="j_g_skip" type="checkbox" style="margin-right:6px;">跳过已分组的好友' + "</div>" + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
        ...
        $("#j_ok").on("click", function() {
            ...
            chrome.storage.sync.get({
                ...
                $("input[name='friend']:checkbox:checked").each(function() {
                    if (g.g_skip) {
                        if (parseInt($(this).parents("div.j-friend").find(".j-grouping").attr("grouping")) == 0) {
                            h.push($.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41))
                        }
                    } else {
                        h.push($.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41))
                    }
        ...
        success: function(m) {
            if (m["included"]) {
                ...
                for (var n = 0; n < t.length; n++) {
                    if (t[n]["$type"] == "com.linkedin.voyager.identity.profile.Profile") {
                        c["urn"] = h;
                        c["publicId"] = d;
                        var q = t[n];
                        if (q && q["locationName"]) {
                    ...
                    if (t[n]["$type"] == "com.linkedin.voyager.identity.shared.MiniProfile") {
                        var u = t[n];
                        if (u && u["firstName"]) {
                        ...
                        if (u && u["picture"] && u["picture"]["rootUrl"] && u["picture"]["artifacts"] && u["picture"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]) {
                            c["img"] = u["picture"]["rootUrl"] + u["picture"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                        } else {
                            c["img"] = ""
                        }
                    }
                    if (t[n]["$type"] == "com.linkedin.voyager.identity.profile.Position") {
                        var k = {};
                        if (t[n]["entityUrn"]) {
                        ...
                        if (t[n]["timePeriod"] && t[n]["timePeriod"]["startDate"] && t[n]["timePeriod"]["startDate"]["year"]) {
                            k["startYear"] = t[n]["timePeriod"]["startDate"]["year"]
                        } else {
                            k["startYear"] = 0
                        }
                        if (t[n]["timePeriod"] && t[n]["timePeriod"]["startDate"] && t[n]["timePeriod"]["startDate"]["month"]) {
                            k["startMonth"] = t[n]["timePeriod"]["startDate"]["month"]
                        } else {
                            k["startMonth"] = 0
                        }
                        if (t[n]["timePeriod"] && t[n]["timePeriod"]["endDate"] && t[n]["timePeriod"]["endDate"]["year"]) {
                            k["endYear"] = t[n]["timePeriod"]["endDate"]["year"]
                        } else {
                            k["endYear"] = 0
                        }
                        if (t[n]["timePeriod"] && t[n]["timePeriod"]["endDate"] && t[n]["timePeriod"]["endDate"]["month"]) {
                    ...
                    if (t[n]["$type"] == "com.linkedin.voyager.identity.profile.Education") {
                        var l = {};
                        if (t[n]["entityUrn"]) {
                        ...
                        if (A["data"]) {
                            ...
                            if (v["ims"]) {
                                ...
                                for (var y = 0; y < v["ims"].length; y++) {
                                    x = x + v["ims"][y]["provider"] + ":" + v["ims"][y]["id"] + ","
                                }
                                c["ims"] = x
                            } else {
                                c["ims"] = ""
                            ...
                            if (v["phoneNumbers"]) {
                                ...
                                for (var y = 0; y < v["phoneNumbers"].length; y++) {
                                    w = w + v["phoneNumbers"][y]["type"] + ":" + v["phoneNumbers"][y]["number"] + " "
                                }
                                c["phone"] = w
                            } else {
                                c["phone"] = ""
                            ...
                            if (v["websites"]) {
                                ...
                                for (var y = 0; y < v["websites"].length; y++) {
                                    C = C + v["websites"][y]["type"]["category"] + ":" + v["websites"][y]["url"] + " "
                                }
                            ...
                            if (i == "f_" || i == "g_") {
                                PointOut("挖掘完成", 1);
                                $("#" + i + h).find(".j-dig svg *").removeClass("j-svg-0");
                                $("#" + i + h).find(".j-dig svg *").addClass("j-svg-1");
                                $("#" + i + h).find(".j-dig").attr("title", "已挖掘，点击查看详情");
                                $("#" + i + h).find(".j-dig").attr("state", 1);
                                ShowProfile(c)
                            }
                            chrome.storage.sync.get({
                                d_today_num: 0
...
function ShowProfile(c) {
    var a = GetName(c["firstname"], c["lastname"]);
    var b = '<div class="j-dialog j-div-center j-detail-bg" title="双击关闭">' + '<div class="j-detail-box j-div-center">' + "<div>" + "<h2>" + a + "</h2>" + "</div>" + "<hr>";
    if (c["email"]) {
        b += '<div class="j-nowrap-left j-contact"><font>邮箱：</font><span>' + c["email"] + "</span></div>"
    }
    if (c["phone"]) {
        b += '<div class="j-nowrap-left j-contact"><font>电话：</font><span>' + c["phone"] + "</span></div>"
    }
    if (c["ims"]) {
        b += '<div class="j-nowrap-left j-contact"><font>社交账号：</font><span>' + c["ims"] + "</span></div>"
    }
    if (c["twitter"]) {
        b += '<div class="j-nowrap-left j-contact"><font>推特：</font><span>' + c["twitter"] + "</span></div>"
    }
    if (c["school"]) {
        b += '<div class="j-nowrap-left"><font>学校：</font><span>' + c["school"] + "</span></div>"
    }
    if (c["country"]) {
        b += '<div class="j-nowrap-left"><font>国家：</font><span>' + c["country"] + "</span></div>"
    }
    if (c["city"]) {
        b += '<div class="j-nowrap-left"><font>城市：</font><span>' + c["city"] + "</span></div>"
    }
    if (c["address"]) {
        b += '<div class="j-nowrap-left"><font>详细地址：</font><span>' + c["address"] + "</span></div>"
    }
    if (c["company"]) {
        b += '<div class="j-nowrap-left"><font>公司：</font><span>' + c["company"] + "</span></div>"
    }
    if (c["position"]) {
        b += '<div class="j-nowrap-left"><font>职位：</font><span>' + c["position"] + "</span></div>"
    }
    if (c["websites"]) {
        b += '<div class="j-nowrap-left"><font>网址：</font><span>' + c["websites"] + "</span></div>"
    }
    if (c["about"]) {
        b += '<div class="j-nowrap-left"><font>个人简介：</font></div>' + '<div class="j-about"><p>' + c["about"] + "</p></div>"
    }
    b += "</div>" + "</div>";
...
function BatchDig() {
    ...
    chrome.storage.sync.get({
        ...
        if (parseInt(a.d_today_num) >= parseInt(a.d_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计挖掘 " + a.d_today_num + " 条，已超设置的每日最多挖掘量，请明天再来挖掘或将每日挖掘量设置大些！")
            }, 50);
            return false
        }
        $("#j_head_img").attr("src", Friend[0]["img"]);
        ...
        if (b > 100) {
            $("#j_today_count").html('<font style="color:#f00;">今日已挖：' + b + "条</font>")
        } else {
            $("#j_today_count").text("今日已挖：" + b + "条")
        }
        Friend.shift();
        var c = GetTime(parseInt(a.d_today_num), parseInt(a.d_min_speed), parseInt(a.d_max_speed), a.risk);
        Delayed_time = c;
        DelayedTime();
        Timeout = setTimeout(function() {
            chrome.runtime.sendMessage({
...
function StartSendForGroup() {
    ...
    var b = $.trim($(this).parents("div.j-group-box").find(".j-groupname").text());
    chrome.storage.sync.get({
        account: "",
        my_urn: "",
        level: 0,
        ...
        if (f <= 0) {
            PointOut("您今天已累计群发" + parseInt(c.s_today_num) + "条消息，已超设置的每日最多群发量，请明天再来群发或将每日群发量设置大些！");
            return false
        }
        if (f > 400) {
            f = 400
...
function GetSendForGroupResult(a) {
    if (a && a["result"]) {
        ...
        PointOut("失败，请重试或尝试刷新页面或重启浏览器，VPN工具不要使用全局模式！")
    }
}
function BatchSendForGroup() {
    ...
    chrome.storage.sync.get({
        ...
        if (!String(a.my_urn)) {
            StopAction();
            setTimeout(function() {
                if (confirm("没有关联Linkedin账号，请先关联Linkedin账号，确定要关联吗？")) {
                    BindLinkedin(false)
                }
            }, 50);
            return false
        ...
        if (parseInt(a.s_today_num) >= parseInt(a.s_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计群发 " + a.s_today_num + " 条消息，已超设置的每日最多群发量，请明天再来群发或将每日群发量设置大些！")
            }, 50);
            return false
        }
        $("#j_head_img").attr("src", Friend[0]["img"]);
        ...
        if (b > 100) {
            $("#j_today_count").html('<font style="color:#f00;">今日已发：' + b + "条</font>")
        } else {
            $("#j_today_count").text("今日已发：" + b + "条")
        }
        Friend.shift();
        var d = GetTime(parseInt(a.s_today_num), parseInt(a.s_min_speed), parseInt(a.s_max_speed), a.risk);
        Delayed_time = d;
        DelayedTime();
        Timeout = setTimeout(function() {
            chrome.runtime.sendMessage({
                action: "loop",
                result: "batchSendForGroup",
                other: ""
            }, function(e) {})
        }, d * 1000)
    })
...
function AddProhibitForFriend() {
    ...
    if (a.length <= 0) {
        ...
        JlConfirm("确定要将选择的 " + a.length + " 位好友添加到禁发名单吗？", "确定");
        $("#j_ok").on("click", function() {
            a = JSON.stringify(a);
    ...
    chrome.storage.sync.get({
        ...
        if (d == 0) {
            ...
            $("#j_ok").click(function() {
                var f = [];
                $("input[name='friend']:checkbox:checked").each(function() {
                    f.push($.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41))
                });
                f = JSON.stringify(f);
...
function BatchSendForFriend() {
    ...
    chrome.storage.sync.get({
        ...
        if (parseInt(b.s_today_num) >= parseInt(b.s_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计群发 " + b.s_today_num + " 条消息，已超设置的每日最多群发量，请明天再来群发或将每日群发量设置大些！")
            }, 50);
            return false
        }
        $("#j_head_img").attr("src", Friend[0]["img"]);
        ...
        $("#j_action_count").text("本次已发：" + ActionCount + "条");
        if (c > 100) {
            $("#j_today_count").html('<font style="color:#f00;">今日已发：' + c + "条</font>")
        } else {
        ...
        var f = GetTime(parseInt(b.s_today_num), parseInt(b.s_min_speed), parseInt(b.s_max_speed), b.risk);
        Delayed_time = f;
        DelayedTime();
        Timeout = setTimeout(function() {
            chrome.runtime.sendMessage({
                action: "loop",
                result: "batchSendForFriend",
                other: ""
            }, function(g) {})
        }, f * 1000)
    })
...
function GetTidingsResult(c) {
    if (c && c["result"] == 1) {
        if (c["data"].length > 0) {
            ...
            PointOut("没有个性邀请消息");
            $("#j_tidings_box").empty();
            var b = '<div class="j-explain-box">' + "<p>没有群发消息内容，点击“新增”按钮可新增群发消息内容。</p>" + '<a href="http://linkedinjl.com/help?o=sendmsg" target="_black">查看详细教程</a>' + "</div>";
...
function AppendTidings(b) {
    var a = "<div j-w>" + '<table class="j-tidings-table">' + "<tbody>" + '<tr class="j-tidings" tid="' + b["tidings_id"] + '">' + '<td title="标题"><h4>' + b["tidings_title"] + "</h4></td>" + '<td><div class="j-tidings-cont" title="双击修改内容">' + b["tidings"] + "</div></td>";
    if (parseInt(b["is_select"]) == 1) {
        a += '<td><div class="j-tidings-select"><input type="checkbox" name="tidings" checked=true' + "></div></td>"
    } else {
        a += '<td><div class="j-tidings-select"><input type="checkbox" name="tidings"></div></td>'
    }
    "<tr>" + "</tbody>" + "</table>" + "</div>";
...
function NewTidings() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>新增群发消息内容</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<input id="j_tidingsTitle" type="text" style="width:94%; margin-bottom:6px;" maxlength=16 placeholder="标题，最长16个字符（标题在群发时不会发送，仅用来方便你管理）">' + '<textarea id="j_tidingsCont" class="j-msg-cont j-w96" maxlength=10000 placeholder="1.群发内容请不要违反领英规则，由于违反领英规则造成的后果由自己承担。&#13;&#10;2.可根据对方姓名智能插入姓氏或名字，把光标定位在需要加入姓氏或名字的位置，点击左下角的“插入姓氏”或“插入名字”按钮即可。"></textarea>' + "</div>" + '<div class="j-prompt-ctrl j-nowrap">' + "<div>" + '<button id="j_tidings_lastname" class="j-bg-btn j-layout-btn">插入姓氏</button>' + '<button id="j_tidings_firstname" style="margin-left:6px;" class="j-bg-btn j-layout-btn">插入名字</button>' + "</div>" + "<div>" + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200);
    $("#j_ok").on("click", function() {
...
function EditTidings() {
    ...
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>修改群发消息内容</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<input id="j_tidingsTitle" type="text" maxlength=16 style="width:94%; margin-bottom:6px;" placeholder="群发消息内容标题，最长16个字符（标题在群发时不会发送，仅用来方便你管理）" value="' + d + '">' + '<textarea id="j_tidingsCont" class="j-msg-cont" maxlength=10000 placeholder="1.群发内容请不要违反领英规则，由于违反领英规则造成的后果由自己承担。&#13;&#10;2.可根据对方姓名智能插入姓氏或名字，把光标定位在需要加入姓氏或名字的位置，点击左下角的“插入姓氏”或“插入名字”按钮即可。">' + b + "</textarea>" + "</div>" + '<div class="j-prompt-ctrl j-nowrap">' + "<div>" + '<button id="j_tidings_lastname" class="j-bg-btn j-layout-btn">插入姓氏</button>' + '<button id="j_tidings_firstname" style="margin-left:6px;" class="j-bg-btn j-layout-btn">插入名字</button>' + "</div>" + "<div>" + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200);
    $("#j_ok").on("click", function() {
    ...
    if (c && c["result"] == 1) {
        ...
        case "show":
            ...
            if (c["data"].length > 0) {
                ...
                var b = '<div class="j-explain-box">' + "<p>没有分组，点击“新增”按钮可以创建分组。</p>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
...
function AppendGroup(b) {
    var a = "<div>" + '<div class="j-group-box j-group-box-not-active j-nowrap" groupid=' + b["group_id"] + ">" + '<div class="j-group j-nowrap-left">' + "<div>" + '<div class="j-svg-group">' + '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" style="width:12px;height:12px;">' + '<polyline stroke="#666" points="0 4, 6 10, 12 4" style="fill:none;stroke-width:1" />' + "</svg>" + "</div>" + "</div>" + "<div>" + '<span class="j-groupname">' + b["group_name"] + "</span>" + '<span id="j_gnum_' + b["group_id"] + '" class="j-group-num"></span>' + "</div>" + "</div>" + '<div class="j-group-edit">' + '<div style="display: flex; justify-content:flex-end;">' + '<div class="j-edit j-svg-ico24" title="修改分组">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 18 l12 0" class="j-svg" style="stroke:#ccc;" />' + '<path d="M6 17 l2 -4 l5 -5 l2 2 l-5 5 z" class="j-svg-bg" />' + '<path d="M15 7 l1 -1 l1 1 l-1 1 z" class="j-svg" />' + "</svg>" + "</div>" + '<div class="j-delete j-svg-ico24" title="删除分组">' + '<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="6" r="1" class="j-svg-bg"/>' + '<path d="M6 8 l12 0" class="j-svg"/>' + '<path d="M8 10 l8 0 l-1 8 l-6 0 z" class="j-svg"/>' + '<path d="M12 10 l0 8" class="j-svg"/>' + "</svg>" + "</div>" + '<div class="j-sort j-svg-ico24" title="分组排序">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M12 5 l6 5 l-12 0 z" class="j-svg-bg" />' + '<path d="M4 12 l16 0" class="j-svg" />' + '<path d="M12 19 l6 -5 l-12 0 z" class="j-svg-bg" />' + "</svg>" + "</div>" + "</div>" + "</div>" + '<div class="j-group-tool">' + '<div style="display: flex; justify-content:flex-end;">' + '<div class="j-move j-svg-ico24" title="移到到其它分组">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 7 l8 0 l0 -3 l4 4.5 l-4 4.5 l0 -3 l-8 0 z" class="j-svg-bg"/>' + '<path d="M6 16 l4 -4.5 l0 3 l8 0 l0 3 l-8 0 l0 3 z" class="j-svg-bg"/>' + "</svg>" + "</svg>" + "</div>" + '<div class="j-export j-svg-ico24" title="导出分组中已挖掘的好友资料">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 14 l0 4 l12 0 l0 -4" class="j-svg" />' + '<path d="M10 16 l0 -6 l4 0 l0 6 z" class="j-svg-bg" />' + '<path d="M7 11 l5 -6 l5 6 z" class="j-svg-bg"/>' + "</svg>" + "</div>" + '<div class="j-dig j-svg-ico24" title="批量挖掘分组中的好友">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="4" class="j-svg" />' + '<path d="M2 12 Q12 2 22 12" class="j-svg" />' + '<path d="M2 12 Q12 22 22 12" class="j-svg" />' + "</svg>" + "</div>" + '<div class="j-send j-svg-ico24" title="批量给分组好友群发消息">' + '<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" version="1.1" >' + '<path d="M9 19 L10 16 A8 5 0 1 1 15 16 Z" class="j-svg"/>' + '<circle cx="8" cy="12" r="1" class="j-svg-bg"/>' + '<circle cx="12" cy="12" r="1" class="j-svg-bg"/>' + '<circle cx="16" cy="12" r="1" class="j-svg-bg"/>' + "</svg>" + "</div>" + '<div class="j-prohibit j-svg-ico24" title="批量添加到禁发名单">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="6" class="j-svg" />' + '<path d="M7 7 l10 10" class="j-svg" />' + "</svg>" + "</div>" + '<div style="margin-top:4px; margin-left:12px; text-align:center;"><input class="j-gall" type="checkbox" title="全选/全不选"/></div>' + "</div>" + "</div>" + "</div>" + '<div class="j-group-friend" id="j_group_' + b["group_id"] + '"></div>' + "</div>";
...
function GetGroupFriendResult(b) {
    if (b && b["result"] == 1) {
        ...
        if (b["total"] == 0) {
            ...
            $("#j_group_" + b["groupId"]).append('<div class="j-friend-not"><p>该分组中没有匹配的好友</p></div>');
            return false
        }
        if (b["data"]) {
            for (var a = 0; a < b["data"].length; a++) {
        ...
        if (b["pos"] >= b["total"]) {
            $("#j_group_" + b["groupId"]).append('<div class="j-friend-not"><p>到底了，没有更多</p></div>')
        } else {
            $("#j_group_" + b["groupId"]).append('<div class="j-load-more j-load-friend" groupid=' + b["groupId"] + " start=" + b["pos"] + ' title="显示更多好友">显示更多</div>')
        }
    } else {
        PointOut("失败，请检查网络，翻墙工具不要使用全局模式！")
    }
...
function AppendGroupFriend(c, f) {
    if (!f["img"]) {
        f["img"] = "https://linkedinjl.oss-cn-beijing.aliyuncs.com/expand/version10/img/me.png"
    }
    ...
    if (f["send_time"]) {
        f["send_time"] = '<font style="color:#f00;">群发:' + f["send_time"] + "</font>"
    } else {
        f["send_time"] = "未群发过"
    }
    var a = GetName(f["first_name"], f["last_name"]);
    var e = '<div class="j-friend j-nowrap" id=g_' + f["urn"] + ' pid="' + f["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">' + '<div><a href="/in/' + f["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + f["img"] + '"></a></div>' + '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline">' + f["position"] + "</p>" + '<div class="j-nowrap-left">' + '<div class="j-edit j-svg-ico18" title="修改备注">' + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M3 15 l12 0" class="j-svg"/>' + '<path d="M3 14 l2 -4 l5 -5 l2 2 l-5 5 z" class="j-svg-bg" />' + '<path d="M12 4 l1 -1 l1 1 l-1 1 z" class="j-svg" />' + "</svg>" + "</div>" + '<div><p class="j-oneline j-remark" title="' + f["remark"] + '">' + f["remark"] + "</p></div>" + "</div>" + "</div>" + "</div>" + '<div class="j-tool-box">' + '<div title="最后群发日期">' + f["send_time"] + "</div>" + '<div class="j-nowrap-left" style="margin-top:18px;">' + '<div class="j-dig j-svg-ico18" state=' + f["dig_state"] + " title=" + d + ">" + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="9" cy="9" r="3" class="j-svg-' + f["dig_state"] + '" />' + '<path d="M2 9 Q9 2 16 9" class="j-svg-' + f["dig_state"] + '" />' + '<path d="M2 9 Q9 16 16 9" class="j-svg-' + f["dig_state"] + '" />' + "</svg>" + "</div>" + '<div class="j-prohibit j-svg-ico18" state=' + f["is_prohibit"] + " title=" + b + ">" + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="9" cy="9" r="5" class="j-svg-' + f["is_prohibit"] + '"/>' + '<path d="M5 5 l8 8" class="j-svg-' + f["is_prohibit"] + '"/>' + "</svg>" + "</div>" + '<div class="j-delete j-svg-ico18" title="将该好友移出分组">' + '<svg width="18px" height="18px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="9" cy="3" r="1" class="j-svg-bg"/>' + '<path d="M3 5 l12 0" class="j-svg"/>' + '<path d="M5 7 l8 0 l-1 8 l-6 0 z" class="j-svg"/>' + '<path d="M9 7 l0 8" class="j-svg"/>' + "</svg>" + "</div>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name=g_' + c + ">" + "</div>" + "</div>";
    $("#j_group_" + c).append(e)
}
...
function NewGroup() {
    chrome.storage.sync.get({
        ...
        $(".j-dialog").remove();
        var c = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha" style="width:40%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>新增分组</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<input id="j_group_name" style="width:90%;" type="text" placeholder="请输入分组名（最多16个字符）" maxlength=16 autofocus="autofocus" />' + "</div>" + '<div class="j-prompt-ctrl" style="width:90%;">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
        $("#j_lyjl_window").append(c);
        $(".j-dialog").fadeIn(200);
        $("#j_ok").on("click", function() {
...
function EditGroup() {
    ...
    $(".j-dialog").remove();
    var b = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha" style="width:40%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 18 l12 0" class="j-svg" style="stroke:#fff;" />' + '<path d="M6 17 l2 -4 l5 -5 l2 2 l-5 5 z" calss="j-svg" style="stroke:none; fill:#fff;" />' + '<path d="M15 7 l1 -1 l1 1 l-1 1 z" class="j-svg" style="stroke:none; fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>修改分组名</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<input id="j_group_name" style="width:90%;" type="text" placeholder="请输入分组名（最多16个字符）" maxlength=16 autofocus="autofocus" value="' + c + '" />' + "</div>" + '<div class="j-prompt-ctrl" style="width:90%;">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(b);
    $(".j-dialog").fadeIn(200);
    $("#j_ok").on("click", function() {
...
function SortGroup(c) {
    $(".j-dialog").remove();
    var b = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha" style="width:50%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 18 l12 0" class="j-svg" style="stroke:#fff;" />' + '<path d="M6 17 l2 -4 l5 -5 l2 2 l-5 5 z" calss="j-svg" style="stroke:#fff;" />' + '<path d="M15 7 l1 -1 l1 1 l-1 1 z" class="j-svg" style="stroke:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>修改分组名</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<div class="j-sort-group-box">';
    for (var a = 0; a < c.length; a++) {
        b += '<div class="j-sort-group j-nowrap" groupid=' + c[a]["group_id"] + ">" + "<div>" + "<p>" + c[a]["group_name"] + "</p>" + "</div>" + '<div class="j-nowrap">' + '<div class="j-svg-ico24 j-up" title="上移">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M4 16 l8 -10 l8 10 z" class="j-svg-bg" />' + "</svg>" + "</div>" + '<div class="j-svg-ico24 j-down" title="下移">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M4 8 l8 10 l8 -10 z" class="j-svg-bg" />' + "</svg>" + "</div>" + "</div>" + "</div>"
    }
    b += "</div>" + "</div>" + '<div class="j-prompt-ctrl">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(b);
    $(".j-dialog").fadeIn(0);
    $("#j_ok").on("click", function() {
        var e = [];
...
function AddProhibitForGroup() {
    ...
    if (b.length <= 0) {
        ...
        JlConfirm("确定要将选择的 " + b.length + " 位好友添加到禁发名单吗？", "确定");
        $("#j_ok").on("click", function() {
            b = JSON.stringify(b);
...
function ShowMoveGroupDialog(d, b) {
    var c = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-box-sha j-bg-w" style="width:40%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 7 l8 0 l0 -3 l4 4.5 l-4 4.5 l0 -3 l-8 0 z" class="j-svg" style="stroke:none; fill:#fff;"/>' + '<path d="M6 16 l4 -4.5 l0 3 l8 0 l0 3 l-8 0 l0 3 z" class="j-svg" style="stroke:none; fill:#fff;"/>' + "</svg>" + "</div>" + "<div>" + "<p>移动分组</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<div><select id="j_select_group" style="padding:6px; width:90%;">';
    for (var a = 0; a < d.length; a++) {
        if (d[a]["group_id"] == b) {
            c += '<option selected="selected" value=' + d[a]["group_id"] + ">" + d[a]["group_name"] + "</option>"
        } else {
            c += "<option value=" + d[a]["group_id"] + ">" + d[a]["group_name"] + "</option>"
        }
    }
    c += "<option value=0>移出分组</option>";
    c += "</select></div>" + "</div>" + '<div class="j-prompt-ctrl" style="width:90%;">' + '<button id="j_move_group" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(c);
    $(".j-dialog").fadeIn(200);
...
function ExportGroupFriend() {
    ...
    chrome.storage.sync.get({
        ...
        if (parseInt(c.level) < 2) {
            ShowUpgrade("没有权限", "非钻石会员不支持导出功能，升级钻石会员可一键导出。");
            return false
        }
        ...
        $("#j_ok").on("click", function() {
            window.open("http://linkedinjl.com/showexport/type/group/account/" + e + "/my_urn/" + d + "/gid/" + a)
        })
    })
}
function StartDigForGroup() {
    ...
    chrome.storage.sync.get({
        ...
        if (d <= 0) {
            PointOut("您今天已累计挖掘" + parseInt(c.d_today_num) + "条，已超设置的每日最多挖掘量，请明天再来挖掘或将每日挖掘量设置大些！");
            return false
        }
...
function EditRemark() {
    ...
    var c = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-box-sha j-bg-w" style="width:50%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<path d="M6 18 l12 0" class="j-svg" style="stroke:#fff;" />' + '<path d="M6 17 l2 -4 l5 -5 l2 2 l-5 5 z" calss="j-svg" style="stroke:none; fill:#fff;" />' + '<path d="M15 7 l1 -1 l1 1 l-1 1 z" class="j-svg" style="stroke:none; fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>修改备注</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont" style="width:96%;">' + '<textarea maxlength=300 id="j_remark" placeholder="请输入备注（最多300个字符）" style="height:100px;">' + d + "</textarea>" + "</div>" + '<div class="j-prompt-ctrl" style="width:92%;">' + '<button id="j_edit_remark" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(c);
    $(".j-dialog").fadeIn(200);
    $("#j_remark").focus();
...
function EditRemarkResult(a) {
    if (a && a["result"] == 1) {
        PointOut("修改成功", 1);
        $(".j-dialog").remove();
        $("#" + a["tag"] + a["urn"]).find(".j-remark").text(a["remark"]);
        $("#" + a["tag"] + a["urn"]).find(".j-remark").attr("title", a["remark"])
    } else {
        PointOut("失败，请尝试刷新页面或重启浏览器")
    }
}
...
function GroupingResult(b) {
    if (b && b["result"] == 1) {
        ...
        case "friend":
            ...
            if (b["data"]) {
                for (var a = 0; a < b["data"].length; a++) {
                    $("#f_" + b["data"][a]).find(".j-grouping").html('<h3 class="j-oneline">' + b["groupName"] + "</h3>");
                    $("#f_" + b["data"][a]).find(".j-grouping").attr("grouping", 1)
                }
            }
            break;
        default:
...
function GetProhibitResult(c) {
    if (c) {
        ...
        case 2:
            $("#j_prohibit_box").empty();
            var b = '<div class="j-explain-box">' + "<p>没有禁发人员，在“我的好友”或“我的分组”中可将好友添加到禁发名单。</p>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>";
...
function AppendProhibit(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id=p_' + c["urn"] + ">" + '<div class="j-profile-box j-nowrap-left">' + '<div><a href="/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + c["img"] + '"></a></div>' + '<div class="j-profile">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline">' + c["position"] + "</p>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name="prohibit">' + "</div>" + "</div>";
    $("#j_prohibit_box").append(b)
}
...
function UpdateProhibitResult(b) {
    if (b && b["result"] == 1) {
        ...
        if (parseInt(b["state"]) == 1) {
            PointOut("已添加到禁发名单");
            for (var a = 0; a < b["friend"].length; a++) {
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit svg *").removeClass("j-svg-0");
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit svg *").addClass("j-svg-1");
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit").attr("state", b["state"]);
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit").attr("title", "已在禁发名单，点击移出")
            }
        } else {
            PointOut("已移出禁发名单");
            for (var a = 0; a < b["friend"].length; a++) {
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit svg *").removeClass("j-svg-1");
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit svg *").addClass("j-svg-0");
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit").attr("state", b["state"]);
                $("#" + b["tag"] + b["friend"][a]).find(".j-prohibit").attr("title", "未在禁发名单，点击加入")
            }
        }
    }
}
...
function GetDigResult(c) {
    if (c) {
        ...
        case 2:
            $("#j_dig_box").empty();
            var b = '<div class="j-explain-box">' + "<p>没有已挖掘的好友，在“我的好友”或“我的分组”中可挖掘好友的资料</p>" + '<a href="http://linkedinjl.com/h" target="_black">查看详细教程</a>' + "</div>" + $("#j_dig_box").append(b);
            PointOut("没有已挖掘的好友");
            break;
        default:
            PointOut("失败，请尝试刷新页面或重启浏览器");
...
function AppendDig(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id=e_' + c["urn"] + ">" + '<div class="j-profile-box j-nowrap-left">' + '<div><a href="/in/' + c["public_id"] + ' "target="_black" title="打开该好友Linkedin主页"><img src="' + c["img"] + '"></a></div>' + '<div class="j-profile" title="双击显示详细资料">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p class="j-oneline">' + c["position"] + "</p>" + '<p style="color:#999;">挖掘日期：' + c["dig_time"] + "</p>" + "</div>" + "</div>" + '<div class="j-tool-box" style="padding-top:24px;">' + '<a class="j-look" href="javascript:;" title="查看详细资料">查看详情</a>' + "</div>" + "<div>" + '<input type="checkbox" name="dig">' + "</div>" + "</div>";
    $("#j_dig_box").append(b)
}
    ...
    chrome.storage.sync.get({
        ...
        if (c == 0) {
            ...
            $("#j_ok").click(function() {
                ...
                e = JSON.stringify(e);
                window.open("http://linkedinjl.com/showexport/type/select/account/" + d + "/my_urn/" + b + "/f/" + e)
            })
        }
    })
}
function ExportForDigTime() {
    chrome.storage.sync.get({
        ...
        var c = '<div class="j-dialog j-div-center">' + '<div class="j-confirm-box j-digdate j-div-center j-box-sha">' + "<div>" + "<p>选择挖掘时间</p>" + "</div>" + '<div class="j-nowrap">' + '<div title="导出今日挖掘的"><input type="radio" name="digtime" value="today" checked="checked">今日</div>' + '<div title="导出近一周挖掘的"><input type="radio" name="digtime" value="week">一周</div>' + '<div title="导出近一月挖掘的"><input type="radio" name="digtime" value="month">一月</div>' + '<div title="导出全部挖掘的"><input type="radio" name="digtime" value="all">全部</div>' + "</div>" + '<div style="text-align:right;">' + '<button id="j_ok" class="j-bg-btn j-layout-btn j-close-dialog">确定</button>' + "</div>" + "</div>" + "</div>";
        var c = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w j-box-sha" style="width:40%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#00f" />' + '<path d="M9 10 A3 3 0 1 1 12 13 l0 3" style="stroke:#fff;" class="j-svg"/>' + '<circle cx="12" cy="18" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>选择挖掘时间</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '<div class="j-nowrap" style="width:80%; margin:auto;">' + '<div title="导出今日挖掘的"><input type="radio" name="digtime" value="today" checked="checked">今日</div>' + '<div title="导出近一周挖掘的"><input type="radio" name="digtime" value="week">一周</div>' + '<div title="导出近一月挖掘的"><input type="radio" name="digtime" value="month">一月</div>' + '<div title="导出全部挖掘的"><input type="radio" name="digtime" value="all">全部</div>' + "</div>" + "</div>" + '<div class="j-prompt-ctrl" style="width:90%;">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">确定</button>' + "</div>" + "</div>" + "</div>";
        $("#j_lyjl_window").append(c);
        $(".j-dialog").fadeIn(200);
        $("#j_ok").on("click", function() {
            var e = $.trim($("input[name='digtime']:checked").val());
            window.open("http://linkedinjl.com/showexport/type/digtime/account/" + d + "/my_urn/" + b + "/digtime/" + e)
        })
    })
}
function ShowFriendProfile() {
...
function GetMyGroups(a) {
    chrome.storage.sync.get({
        ...
        var f = 10;
        var h = (a - 1) * 10;
        var d = "https://www.linkedin.com/voyager/api/voyagerGroupsDashGroups?decorationId=com.linkedin.voyager.dash.deco.groups.GroupListingPage-2&count=" + f + "&membershipStatuses=List(MEMBER,MANAGER,OWNER)&profileUrn=urn%3Ali%3Afsd_profile%3A" + e + "&q=member&start=" + h;
        ...
        $.ajax({
            ...
            success: function(q) {
                if (q && q["data"] && q["data"]["*elements"] && q["included"]) {
                    ...
                    if (o == 0) {
                        var n = '<div class="j-explain-box">' + '<p>你没有Groups，请在领英上<a href="https://www.linkedin.com/search/results/groups" target="_black">添加Groups</a>。<p/>' + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
                    ...
                    for (var m = 0; m < p.length; m++) {
                        ...
                        for (var l = 0; l < r.length; l++) {
                            if (r[l]["$type"] == "com.linkedin.voyager.dash.groups.Group" && r[l]["entityUrn"].substr(17) == p[m].substr(17)) {
                                k["name"] = r[l]["name"];
                                k["memberCount"] = r[l]["memberCount"];
                                if (r[l]["logo"] && r[l]["logo"]["vectorImage"] && r[l]["logo"]["vectorImage"]["rootUrl"] && r[l]["logo"]["vectorImage"]["artifacts"]) {
                                    k["img"] = r[l]["logo"]["vectorImage"]["rootUrl"] + r[l]["logo"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                                } else {
                                    k["img"] = ""
                                }
                    ...
                    PointOut("获取失败", 3);
                    $("#j_myGroups_box").empty();
                    var n = '<div class="j-explain-box">' + "<p>Groups获取失败，请确检查网络，或确保您打开的领英是领英国际版本。<p/>" + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
                    $("#j_myGroups_box").append(n);
                    return false
                }
            },
            error: function() {
                PointOut("获取失败", 3);
                $("#j_myGroups_box").empty();
                var i = '<div class="j-explain-box">' + "<p>Groups获取失败，请确检查网络，或确保您打开的领英是领英国际版本。<p/>" + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
...
function AppendMyGroupsToTable(b) {
    var a = '<div class="j-friend j-nowrap" gid="s_' + b["groupsId"] + '" gN="' + b["name"] + '">' + '<div class="j-profile-box j-nowrap-left">' + "<div>" + '<a href="https://www.linkedin.com/groups/' + b["groupsId"] + ' "target="_black" title="打开Groups主页"><img src="' + b["img"] + '"></a>' + "</div>" + '<div class="j-profile">' + '<h3 class="j-oneline">' + b["name"] + "</h3>" + '<p class="j-oneline">成员：' + b["memberCount"] + "人</p>" + "</div>" + "</div>" + "<div>" + '<div style="padding:18px 12px;">' + '<a class="j-all-groups-member" href="javascript:;" title="显示全部成员">全部成员</a>' + "</div>" + "</div>" + "</div>";
...
function GetGroupsMember(a, e, f) {
    ...
    var d = 40;
    var g = (f - 1) * 40;
    var c = "https://www.linkedin.com/voyager/api/voyagerGroupsDashGroupMemberships?decorationId=com.linkedin.voyager.dash.deco.groups.GroupMembershipInMemberListPage-2&count=" + d + "&filters=List()&groupUrn=urn%3Ali%3Afsd_group%3A" + a + "&membershipStatuses=List(OWNER,MANAGER,MEMBER)&q=typeahead&start=" + g + "&typeaheadQuery=%22%22";
    $.ajax({
        url: c,
        type: "get",
        headers: {
        ...
        success: function(l) {
            if (l && l["data"] && l["data"]["*elements"] && l["included"]) {
                ...
                if (j == 0) {
                    var i = '<div class="j-explain-box">' + "<p>该Groups中没有成员。<p/>" + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
                    $("#j_GroupsMember_box").append(i);
                    return false
                } else {
                    var i = '<div class="j-nowrap j-num j-w">' + '<div style="width:80%;">' + '<h3 id="j_GroupsName" class="j-oneline" gid="' + a + '" gn="' + e + '">' + e + "</h3>" + "</div>" + "<div><span>" + h + " 成员</span></div>" + "</div>";
                    $("#j_GroupsMember_box").append(i)
                }
                var k = l["data"]["*elements"];
                var m = l["included"];
                    ...
                    for (var q = 0; q < k.length; q++) {
                        ...
                        if (n["urn"] != r) {
                            for (var p = 0; p < m.length; p++) {
                                if (m[p]["$type"] == "com.linkedin.voyager.dash.identity.profile.Profile" && m[p]["entityUrn"].substr(19, 39) == n["urn"]) {
                                    ...
                                    if (m[p]["profilePicture"] && m[p]["profilePicture"]["displayImageReference"] && m[p]["profilePicture"]["displayImageReference"]["vectorImage"] && m[p]["profilePicture"]["displayImageReference"]["vectorImage"]["rootUrl"]) {
                                        n["img"] = m[p]["profilePicture"]["displayImageReference"]["vectorImage"]["rootUrl"] + m[p]["profilePicture"]["displayImageReference"]["vectorImage"]["artifacts"][0]["fileIdentifyingUrlPathSegment"]
                                    } else {
                                        n["img"] = ""
                                    }
                                }
                                if (m[p]["$type"] == "com.linkedin.voyager.dash.relationships.MemberRelationship" && m[p]["entityUrn"].substr(30, 39) == k[q].substr(36, 39)) {
                                    if (m[p]["memberRelationshipUnion"] && m[p]["memberRelationshipUnion"]["noConnection"] && m[p]["memberRelationshipUnion"]["noConnection"]["memberDistance"]) {
                                        switch (m[p]["memberRelationshipUnion"]["noConnection"]["memberDistance"]) {
                                        case "DISTANCE_3":
                                            n["distance"] = "3度";
                                            break;
                                        case "DISTANCE_2":
                ...
                PointOut("获取失败", 3);
                $("#j_GroupsMember_box").empty();
                var i = '<div class="j-explain-box">' + "<p>Groups成员获取失败。请检查网络并确保打开的领英页面是领英国际版本。<p/>" + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
                $("#j_GroupsMember_box").append(i);
        ...
        error: function() {
            PointOut("获取失败", 3);
            $("#j_GroupsMember_box").empty();
            var h = '<div class="j-explain-box">' + "<p>Groups成员获取失败。请检查网络并确保打开的领英页面是领英国际版本。<p/>" + '<a href="http://linkedinjl.com/help" target="_black">查看详细教程</a>' + "</div>";
...
function AppendMemberToTable(c) {
    ...
    var b = '<div class="j-friend j-nowrap" id="m_' + c["urn"] + '" fn="' + c["first_name"] + '" ln="' + c["last_name"] + '" pid="' + c["public_id"] + '">' + '<div class="j-profile-box j-nowrap-left">' + "<div>" + '<a href="https://www.linkedin.com/in/' + c["public_id"] + ' "target="_black" title="打开该成员Linkedin主页"><img src="' + c["img"] + '"></a>' + "</div>" + '<div class="j-profile">' + '<div class="j-nowrap-left">' + '<h3 class="j-oneline">' + a + "</h3>" + '<p style="line-height:24px; padding-left:6px">' + c["distance"] + "</p>" + "</div>" + "<div>" + '<p class="j-oneline j-posi">' + c["position"] + "</p>" + "</div>" + "</div>" + "</div>" + "<div>" + '<input type="checkbox" name="GroupsMember">' + "</div>" + "</div>";
...
function ConnectGroups() {
    if (Friend.length > 0) {
        Connect(Friend[0]["urn"], Friend[0]["first_name"], Friend[0]["last_name"], Friend[0]["img"], "groups");
        ...
        chrome.storage.sync.get({
            ...
            var f = GetTime(parseInt(e.a_today_num), parseInt(e.a_min_speed), parseInt(e.a_max_speed), e.risk);
            Delayed_time = f;
            DelayedTime();
            Timeout = setTimeout(function() {
                chrome.runtime.sendMessage({
                    action: "loop",
                    result: "connectGroups",
                    other: ""
                }, function(g) {})
            }, f * 1000)
        })
    ...
    chrome.storage.sync.get({
        ...
        if (c == 0) {
            ...
            $("#j_ok").click(function() {
                ...
                $("input[name='GroupsMember']:checkbox:checked").each(function() {
                    var e = {};
                    e["urn"] = $.trim($(this).parents("div.j-friend").attr("id")).slice(2, 41);
                    e["first_name"] = $.trim($(this).parents("div.j-friend").attr("fn"));
                    e["last_name"] = $.trim($(this).parents("div.j-friend").attr("ln"));
                    e["public_id"] = $.trim($(this).parents("div.j-friend").attr("pid"));
                    e["img"] = $.trim($(this).parents("div.j-friend").find("img").attr("src"));
                    Friend.push(e)
                });
...
function BatchSendGroups() {
    ...
    chrome.storage.sync.get({
        ...
        if (parseInt(c.s_today_num) >= parseInt(c.s_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计群发 " + c.s_today_num + " 条消息，已超设置的每日最多群发量，请明天再来群发或将每日群发量设置大些！")
            }, 50);
            return false
        }
        $("#j_head_img").attr("src", Friend[0]["img"]);
        ...
        $("#j_action_count").text("本次已发：" + ActionCount + "条");
        if (d > 100) {
            $("#j_today_count").html('<font style="color:#f00;">今日已发：' + d + "条</font>")
        } else {
            $("#j_today_count").text("今日已发：" + d + "条")
        }
        var h = GetTime(parseInt(c.s_today_num), parseInt(c.s_min_speed), parseInt(c.s_max_speed), c.risk);
        Delayed_time = h;
        DelayedTime();
        Friend.shift();
        Timeout = setTimeout(function() {
...
function SendMsgGroups(b, c) {
    ...
    chrome.storage.sync.get({
        ...
        var g = "https://www.linkedin.com/voyager/api/voyagerMessagingDashMessengerMessages?action=createMessage";
        $.ajax({
            url: g,
            data: JSON.stringify(d),
            type: "post",
...
function CopyLink() {
    chrome.storage.sync.get({
        ...
        if (a.level > 0) {
            ...
            ShowUpgrade("没有权限", "非领英精灵会员没有提成权限，升级领英精灵会员即可享受提成")
        }
    })
}
...
function GetLogResult(c) {
    if (c && c["result"] == 1) {
        PointOut("完成", 1);
        $(".j-dialog").remove();
        var b = '<div class="j-dialog j-div-center j-close-dialog">' + '<div class="j-prompt-box j-div-center j-box-sha j-bg-w">' + '<div class="j-prompt-cont">' + '<h3 style="text-align:center; margin:12px; color:#000;">操作日志</h3>' + '<div style="min-height:200px;" class="j-w">' + '<table class="j-tab j-tab-log">' + "<thead>" + "<tr>" + "<th>日期</th>" + '<th title="通过领英精灵每天群发消息数量">群发</th>' + '<th title="领英精灵每天挖掘到的好友资料数量">挖掘</th>' + '<th title="通过领英精灵每天发出的邀请数量">加好友</th>' + '<th title="通过领英精灵每天批量点赞的数量">点赞</th>' + "</tr>" + "</thead>" + '<tbody style="max-height: 30px; overflow-y:auto;">';
        for (var a = 0; a < c["data"].length; a++) {
            b += "<tr>" + "<td>" + c["data"][a]["log_date"] + "</td>" + "<td>" + c["data"][a]["send_num"] + "</td>" + "<td>" + c["data"][a]["dig_num"] + "</td>" + "<td>" + c["data"][a]["add_num"] + "</td>" + "<td>" + c["data"][a]["thumbs_num"] + "</td>" + "</tr>"
        }
        b += "</tbody>" + "</table>" + "</div>" + "</div>" + '<div class="j-prompt-ctrl">' + "<p>*以上数据是领英精灵统计的，仅供参考，与实际的会有些出入属于正常现象</p>" + "</div>" + "</div>" + "</div>";
        $("#j_lyjl_window").append(b);
        $(".j-dialog").fadeIn(200)
    } else {
        PointOut("失败，请检查网络，翻墙工具不要使用全局模式！")
...
function JlConfirm(b) {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-confirm-box j-div-center j-box-sha">' + '<div class="j-nowrap">' + '<div class="j-nowrap">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#00f" />' + '<path d="M9 10 A3 3 0 1 1 12 13 l0 3" style="stroke:#fff;" class="j-svg"/>' + '<circle cx="12" cy="18" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<h3>确定</h3>" + "</div>" + "</div>" + '<div class="j-marg"><p>' + b + "</p></div>" + '<div style="text-align:right;">' + '<button id="j_cancel" class="j-bg-btn j-layout-btn j-close-dialog">取消</button>' + '<button id="j_ok" class="j-bg-btn j-layout-btn j-close-dialog">确定</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(0)
}
function JlAlert(b) {
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-confirm-box j-div-center j-box-sha">' + '<div class="j-nowrap">' + '<div class="j-nowrap">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#f00;" />' + '<path d="M11 6 l2 0 l-0.5 9 l-1 0 z" style="fill:#fff;"/>' + '<circle cx="12" cy="17" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<h3>注意</h3>" + "</div>" + "</div>" + '<div class="j-marg">' + "<p>" + b + "</p>" + "</div>" + '<div style="text-align:right;">' + '<button class="j-bg-btn j-layout-btn j-close-dialog">确认</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(0)
}
...
function JlHttp(d, c, b, a) {
    chrome.runtime.sendMessage({
        "url": "http://jl.fnwnet.cn/actionten",
        "action": "jlHttp",
        "type": d,
        "data": c,
        "tag": b,
...
function ShowLoginDialog() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-login-box j-bg-w j-div-center j-box-sha">' + '<div class="j-logo" style="margin:auto;"></div>' + '<p id="j_errmsg" class="j-errmsg">请登录领英精灵</p>' + "<div>" + '<input id="j_acc" type="text" placeholder="领英精灵账号">' + "</div>" + "<div>" + '<input id="j_pw" type="password" placeholder="登录密码">' + "</div>" + "<div>" + '<button id="j_login" class="j-login-btn j-bg-btn">登录</button>' + "</div>" + '<div class="j-nowrap">' + '<a href="http://linkedinjl.com/r" target="_black" title="前往免费注册">免费注册</a>' + '<a href="http://linkedinjl.com/resetpw" target="_black" title="找回密码">忘记密码</a>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200)
}
function Login() {
...
function ShowPaging(j, d, h, g) {
    ...
    if (b > 1) {
        var a = d > 2 ? d - 2 : 1;
        var e = d + 2 > b ? b : d + 2;
        var c = '<div class="j-nowrap">' + '<div class="j-nowrap">' + '<input type="text" style="width:42px; margin-right:0px;" class="j-jump" title="输入页码，按回车键，直接跳到相应页" value="' + d + '">' + '<button class="j-bg-btn j-layout-btn j-jump-btn">跳到</button>' + "</div>" + '<div style="height:32px; padding-top:6px;">';
        if (a != 1) {
...
function InsertAfterText(b, e) {
    ...
    if (document.selection) {
        ...
        if (b.selectionStart || b.selectionStart == "0") {
            ...
            var f = b.scrollTop;
            b.value = b.value.substring(0, d) + e + b.value.substring(c, b.value.length);
            b.focus();
...
function ShowUpgrade(d, c, b) {
    b = b || "立即升级";
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w g-box-sha" style="width:35%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#f00;" />' + '<path d="M11 6 l2 0 l-0.5 9 l-1 0 z" style="fill:#fff;"/>' + '<circle cx="12" cy="17" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>" + d + "</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont" style="width:90%;>' + '<div class="j-diff-cont" ><div>' + "<p>" + c + "</p >" + "</div>" + "</div>" + '<div class="j-prompt-ctrl" style="width:90%; margin-top:12px;">' + '<a href="javascript:;" class="j-upgrade" style="margin-right:12px;" >查看权限</a>' + '<button class="j-upgrade j-bg-btn j-layout-btn">' + b + "</button>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200)
}
function ShowPropose() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-box-sha j-bg-w">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg">' + '<line x1="6" y1="12" x2="18" y2="12" />' + '<line x1="12" y1="6" x2="12" y2="18" />' + "</svg>" + "</div>" + "<div>" + "<p>我的建议</p>" + "</div>" + "</div>" + '<div title="关闭" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + '<div class="j-prompt-cont">' + '</span><textarea id="j_propose" autofocus="autofocus" placeholder="欢迎提出您的宝贵建议，您的建议是我们改进的方向，我公司将认真听取您的建议（有关产品的问题、功能，需要添加什么功能都可以提出）" maxlength=300></textarea>' + "</div>" + '<div class="j-prompt-ctrl">' + '<button id="j_ok" class="j-bg-btn j-layout-btn">提交</button>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200);
    $("#j_propose").focus();
    $("#j_ok").on("click", function() {
...
function startLikes() {
    ...
    chrome.storage.sync.get({
        ...
        getPosts(0, "", startLikeCallback)
    })
}
function startLikeCallback(a) {
    switch (a) {
    case 0:
        PointOut("请确保领英账号已正常登录，请尝试刷新领英页面。");
        break;
...
function getPosts(e, d, c) {
    ...
    if (d) {
        var b = "https://www.linkedin.com/voyager/api/feed/updatesV2?commentsCount=0&count=40&likesCount=0&moduleKey=home-feed%3Adesktop&paginationToken=" + d + "&q=feed&sortOrder=RELEVANCE&start=" + e
    } else {
        var b = "https://www.linkedin.com/voyager/api/feed/updatesV2?commentsCount=0&count=40&likesCount=0&moduleKey=home-feed%3Adesktop&q=feed&sortOrder=RELEVANCE&start=" + e
    }
    $.ajax({
        url: b,
        type: "get",
        ...
        success: function(k) {
            if (k) {
                try {
                    var l = k["included"];
                    var m = k["data"]["paging"]["start"] + k["data"]["paging"]["count"];
                    var j = k["data"]["paging"]["total"];
                    var n = k["data"]["metadata"]["paginationToken"];
                    chrome.storage.sync.set({
                        postStart: m,
                        postTotal: j,
                        paginationToken: n
                ...
                for (var h = 0; h < l.length; h++) {
                    if (l[h]["$type"] == "com.linkedin.voyager.feed.SocialDetail") {
                        var f = RegExp("(?<=ugcPost:)\\d+").exec(l[h]["urn"]);
                        if (f && l[h]["liked"] == false) {
                            POSTS.push(f[0])
                        }
                    }
                }
...
function loopLikes() {
    chrome.storage.sync.get({
        ...
        if (parseInt(a.level) < 1 && parseInt(a.t_today_num) >= TestCount) {
            StopAction();
            setTimeout(function() {
        ...
        if (parseInt(a.t_today_num) >= parseInt(a.t_limit)) {
            StopAction();
            setTimeout(function() {
                alert("今日累计点赞 " + parseInt(a.t_today_num) + " 条，已超设置的每日最多点赞量，请明天再来点赞或将每日点赞量设置大些！")
            }, 50);
            return false
        }
        if (POSTS.length > 0) {
            likes(POSTS[0]);
            ActionCount++;
            var b = parseInt(a.t_today_num) + 1;
            chrome.storage.sync.set({
                t_today_num: [b]
            }, function() {});
            POSTS.shift();
            if (POSTS.length < 1 && parseInt(a.postStart) < parseInt(a.postTotal)) {
                getPosts(parseInt(a.postStart), a.paginationToken, function(d) {})
            }
            var c = GetTime(parseInt(a.t_today_num), parseInt(a.t_min_speed), parseInt(a.t_max_speed), a.risk);
            Delayed_time = c;
            DelayedTime();
            $("#j_action_count").text("本次已赞：" + ActionCount + "条");
            if (b > 100) {
                $("#j_today_count").html('<font style="color:#f00;">今日已赞：' + b + "条</font>")
            } else {
                $("#j_today_count").text("今日已赞：" + b + "条")
            }
            Timeout = setTimeout(function() {
                chrome.runtime.sendMessage({
                    action: "loop",
...
function likes(b) {
    ...
    var e = ["LIKE", "PRAISE", "APPRECIATION", "EMPATHY", "INTEREST", "ENTERTAINMENT"];
    var a = {
        "reactionType": e[Math.floor(Math.random() * 6)]
    };
    var d = "https://www.linkedin.com/voyager/api/voyagerSocialDashReactions?threadUrn=" + encodeURIComponent(b);
    $.ajax({
        url: d,
        type: "post",
        data: JSON.stringify(a),
...
function ShowStatu(b) {
    var a = '<div id="j_statu_dialog" class="j-gdialog j-box-sha" title="请不要关闭此页面，如要操作，请先停止">' + '<div class="j-warn">请不要关闭此页面，并保持此页面显示在最前面。如要操作，请先停止。</div>' + '<div class="j-statu-dialog j-box-sha">' + '<div class="j-bg-0 j-dialog-title j-nowrap">' + "<h3>领英精灵</h3>" + "<p>" + b + "</p>" + "</div>" + '<div class="j-nowrap">' + '<div class="j-statu-content">' + '<img id="j_head_img" src="https://linkedinjl.oss-cn-beijing.aliyuncs.com/expand/version10/img/logo.png" class="j-statu-img rotation">' + "</div>" + '<div class="j-statu-content">' + '<p id="j_countdown">倒计时：秒</p>' + '<p id="j_action_count">本次：0 条</p>' + '<p id="j_today_count">今日：0 条</p>' + "</div>" + '<div class="j-statu-content">' + '<button id="j_stop_action" class="j-bg-btn j-layout-btn" title="停止操作">停止</button>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("body").append(a);
    $(".j-gdialog").fadeIn(0);
    chrome.storage.sync.set({
        run: true
...
function ContactMe() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-prompt-box j-div-center j-bg-w g-box-sha" style="width:50%;">' + '<div class="j-prompt-title j-bg-0 j-nowrap">' + '<div class="j-nowrap-left">' + "<div>" + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" >' + '<circle cx="12" cy="12" r="10" style="fill:#00f" />' + '<path d="M9 10 A3 3 0 1 1 12 13 l0 3" style="stroke:#fff;" class="j-svg"/>' + '<circle cx="12" cy="18" r="1" style="fill:#fff;" />' + "</svg>" + "</div>" + "<div>" + "<p>联系我们</p>" + "</div>" + "</div>" + '<div title="Close" class="j-close-dialog j-sha">' + '<svg width="24px" height="24px" xmlns="https://www.w3.org/2000/svg" version="1.1" class="j-title-svg" >' + '<line x1="6" y1="6" x2="18" y2="18" />' + '<line x1="18" y1="6" x2="6" y2="18" />' + "</svg>" + "</div>" + "</div>" + "<div>" + '<div style="text-align:center;padding:24px 24px 0px 24px;">' + '<p style="font-size:14px; color:red;">您不是会员，请<a style="font-weight:bold;" href="javescript:;" class="j-upgrade">升级会员</a>使用</p>' + "</div>" + "<div>" + '<img class="j-customer" src="https://linkedinjl.oss-cn-beijing.aliyuncs.com/expand/version10/img/contactus.png" />' + "</div>" + '<div style="text-align:center;padding:0px 24px 24px 24px;">' + '<p style="color:#999;">以上是您的专属客服，联系客服可开通试用</p>' + "</div>" + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200)
}
function Renew() {
    $(".j-dialog").remove();
    var a = '<div class="j-dialog j-div-center">' + '<div class="j-bg-w j-login-box j-div-center j-box-sha">' + '<div style="width:300px;">' + '<h3 style="color:#f00;text-align:center;">版本过旧</h3>' + '<p style="margin:6px; line-heigth:18px; text-align:left;">您的领英精灵插件版本太旧，请更新到最新版使用。</p>' + '<p style="text-align:right;"><a href="http://linkedinjl.com/h?o=upgrade" target="_black">立即更新</a></p>' + "</div>" + "</div>" + "</div>";
    $("#j_lyjl_window").append(a);
    $(".j-dialog").fadeIn(200)
}
function getUrl() {
